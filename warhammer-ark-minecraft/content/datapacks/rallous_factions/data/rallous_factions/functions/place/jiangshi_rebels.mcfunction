# place Jiangshi Rebels — Jiangshi Lord Prince Jiang
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.jiangshi_rebels,limit=1,sort=nearest] run scoreboard players set @s rallous.fac.stance 2
