...
execute if score $skip rallous.gen matches 0 run summon minecraft:villager ~0.6 ~ ~ {CustomName:'{"text":"Elector Count of Middenland Boris Todbringer","color":"red","bold":true}',CustomNameVisible:1b,PersistenceRequired:1b,Invulnerable:1b,NoAI:1b,Tags:["rallous.lord","rallous.fac.middenland"],VillagerData:{profession:"minecraft:weaponsmith",level:3,type:"minecraft:plains"},HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],ArmorItems:[{id:"minecraft:iron_boots",Count:1b},{id:"minecraft:iron_leggings",Count:1b},{id:"minecraft:iron_chestplate",Count:1b},{id:"minecraft:iron_helmet",Count:1b}]}
...
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.middenland,limit=1,sort=nearest] armor.head with sonsoftheempire:swordsman_armor_helmet 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.middenland,limit=1,sort=nearest] armor.chest with sonsoftheempire:swordsman_armor_chestplate 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.middenland,limit=1,sort=nearest] armor.legs with sonsoftheempire:swordsman_armor_leggings 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.middenland,limit=1,sort=nearest] armor.feet with sonsoftheempire:swordsman_armor_boots 1
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.middenland,limit=1,sort=nearest] at @s run function rallous_factions:host/levy
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.middenland,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
