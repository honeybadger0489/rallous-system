...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.drippin_fangs,limit=1,sort=nearest] at @s run function rallous_factions:host/levy
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.drippin_fangs,limit=1,sort=nearest] run scoreboard players set @s rallous.fac.stance 1
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.drippin_fangs,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
