# place Clan Treecherik — Assassin Treecherik (under-empire war host)
execute if score #clan_treecherik rallous.used matches 1 run scoreboard players set $skip rallous.gen 1
execute unless score #clan_treecherik rallous.used matches 1 run scoreboard players set $skip rallous.gen 0
...
execute if score $skip rallous.gen matches 0 run summon minecraft:marker ~ ~ ~ {Tags:["rallous.camp","rallous.fac.clan_treecherik"],CustomName:'{"text":"Assassin Treecherik","color":"light_purple","bold":true}'}
execute if score $skip rallous.gen matches 0 run summon minecraft:villager ~0.6 ~ ~ {CustomName:'{"text":"Assassin Treecherik","color":"light_purple","bold":true}',CustomNameVisible:1b,PersistenceRequired:1b,Invulnerable:1b,NoAI:1b,Tags:["rallous.lord","rallous.fac.clan_treecherik"],VillagerData:{profession:"minecraft:toolsmith",level:3,type:"minecraft:swamp"},HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:4863784}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:4863784}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:4863784}}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:4863784}}}]}
execute if score $skip rallous.gen matches 0 run summon recruits:recruit ~2 ~ ~1 {CustomName:'{"text":"Clanrat","color":"light_purple"}',CustomNameVisible:1b,PersistenceRequired:1b,CanPickUpLoot:0b,Tags:["rallous.soldier","rallous.fac.clan_treecherik"]}
execute if score $skip rallous.gen matches 0 run summon recruits:scout ~-2 ~ ~1 {CustomName:'{"text":"Night Runner","color":"light_purple"}',CustomNameVisible:1b,PersistenceRequired:1b,CanPickUpLoot:0b,Tags:["rallous.soldier","rallous.fac.clan_treecherik"]}
