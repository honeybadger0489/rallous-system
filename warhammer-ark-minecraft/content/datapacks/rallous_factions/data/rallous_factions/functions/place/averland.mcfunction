...
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.averland,limit=1,sort=nearest] armor.head with sonsoftheempire:swordsman_armor_helmet 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.averland,limit=1,sort=nearest] armor.chest with sonsoftheempire:swordsman_armor_chestplate 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.averland,limit=1,sort=nearest] armor.legs with sonsoftheempire:swordsman_armor_leggings 1
execute if score $skip rallous.gen matches 0 run item replace entity @e[type=minecraft:villager,tag=rallous.lord,tag=rallous.fac.averland,limit=1,sort=nearest] armor.feet with sonsoftheempire:swordsman_armor_boots 1
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.averland,limit=1,sort=nearest] at @s run function rallous_factions:host/levy
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.averland,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
