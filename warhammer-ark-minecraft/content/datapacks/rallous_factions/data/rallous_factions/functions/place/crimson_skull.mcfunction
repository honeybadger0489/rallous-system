...
execute if score $skip rallous.gen matches 0 run summon minecraft:villager ~0.6 ~ ~ {CustomName:'{"text":"Skullmaster Crimson Skull","color":"dark_red","bold":true}',CustomNameVisible:1b,PersistenceRequired:1b,Invulnerable:1b,NoAI:1b,Tags:["rallous.lord","rallous.fac.crimson_skull"],VillagerData:{profession:"minecraft:weaponsmith",level:3,type:"minecraft:savanna"},HandItems:[{id:"minecraft:iron_axe",Count:1b},{}],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:11546150}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:11546150}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:11546150}}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:11546150}}}]}
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.crimson_skull,limit=1,sort=nearest] at @s run function rallous_factions:host/levy
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.crimson_skull,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
