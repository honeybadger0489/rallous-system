# place Bonerattlaz — Orc Warboss Azhag the Slaughterer
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.bonerattlaz,limit=1,sort=nearest] run scoreboard players set @s rallous.fac.stance 2
