...
execute if score $skip rallous.gen matches 0 run summon minecraft:villager ~0.6 ~ ~ {CustomName:'{"text":"Bray-Shaman Slugtongue’s Kin","color":"dark_green","bold":true}',CustomNameVisible:1b,PersistenceRequired:1b,Invulnerable:1b,NoAI:1b,Tags:["rallous.lord","rallous.fac.manblight_tribe"],VillagerData:{profession:"minecraft:nitwit",level:3,type:"minecraft:taiga"},HandItems:[{id:"minecraft:stone_axe",Count:1b},{}],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:8602624}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:8602624}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:8602624}}},{id:"minecraft:skeleton_skull",Count:1b}]}
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.manblight_tribe,limit=1,sort=nearest] at @s run function rallous_factions:host/levy
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.manblight_tribe,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
