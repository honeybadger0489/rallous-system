# place Broken Axe — Goblin Warboss Grom the Paunch (waaagh war host)
execute if score #broken_axe rallous.used matches 1 run scoreboard players set $skip rallous.gen 1
execute unless score #broken_axe rallous.used matches 1 run scoreboard players set $skip rallous.gen 0
...
execute if score $skip rallous.gen matches 0 run summon minecraft:marker ~ ~ ~ {Tags:["rallous.camp","rallous.fac.broken_axe"],CustomName:'{"text":"Goblin Warboss Grom the Paunch","color":"green","bold":true}'}
execute if score $skip rallous.gen matches 0 run summon minecraft:villager ~0.6 ~ ~ {CustomName:'{"text":"Goblin Warboss Grom the Paunch","color":"green","bold":true}',CustomNameVisible:1b,PersistenceRequired:1b,Invulnerable:1b,NoAI:1b,Tags:["rallous.lord","rallous.fac.broken_axe"],VillagerData:{profession:"minecraft:nitwit",level:3,type:"minecraft:savanna"},HandItems:[{id:"minecraft:iron_axe",Count:1b},{}]}
...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.broken_axe,limit=1,sort=nearest] run scoreboard players set @s rallous.fac.stance 2
