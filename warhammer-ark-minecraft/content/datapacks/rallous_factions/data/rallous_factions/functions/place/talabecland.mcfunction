...
execute if score $skip rallous.gen matches 0 as @e[type=minecraft:marker,tag=rallous.fac.talabecland,limit=1,sort=nearest] at @s run function rallous_temple_herd:mark_camp
