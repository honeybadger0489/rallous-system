tellraw @a[distance=..48] [{"text": "<Beastlord Ripper-Horn — Ripper-Horn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Ripper-Horn Tribe does not share this camp. Run, or be eaten.", "color": "red"}]
