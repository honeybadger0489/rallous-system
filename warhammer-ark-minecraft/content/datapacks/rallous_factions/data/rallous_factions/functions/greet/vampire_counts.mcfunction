tellraw @a[distance=..48] [{"text": "<Master Necromancer Helman Ghorst — Vampire Counts> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Vampire Counts do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
