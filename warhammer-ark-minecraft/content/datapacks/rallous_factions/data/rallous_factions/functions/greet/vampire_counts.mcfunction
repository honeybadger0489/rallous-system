tellraw @a[distance=..48] [{"text": "<Master Necromancer Helman Ghorst — Vampire Counts> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Vampire Counts. Then we may name you guest.", "color": "yellow"}]
