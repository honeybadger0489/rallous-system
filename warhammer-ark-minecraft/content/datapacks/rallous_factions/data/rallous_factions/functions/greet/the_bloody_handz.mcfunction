tellraw @a[distance=..48] [{"text": "<Great Shaman Wurrzag da Great Green Prophet — The Bloody Handz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv The Bloody Handz. Then da boss might keep ya.", "color": "yellow"}]
