tellraw @a[distance=..48] [{"text": "<Great Bray-Shaman Malagor the Dark Omen — Harbinger of Disaster> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Harbinger of Disaster does not share this camp. Run, or be eaten.", "color": "red"}]
