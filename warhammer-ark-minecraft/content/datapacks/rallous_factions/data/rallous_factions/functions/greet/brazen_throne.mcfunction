tellraw @a[distance=..48] [{"text": "<Bloodmaster Brazen Throne — Brazen Throne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Brazen Throne does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/brazen_throne
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/brazen_throne
