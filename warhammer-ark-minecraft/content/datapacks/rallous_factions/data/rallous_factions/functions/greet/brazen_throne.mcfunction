tellraw @a[distance=..48] [{"text": "<Bloodmaster Brazen Throne — Brazen Throne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Brazen Throne, or die on this picket.", "color": "red"}]
