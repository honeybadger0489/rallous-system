tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Black Pit — The Black Pit Tribe> ", "color": "green", "bold": true}, {"text": "Drakwald hole. War from below. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
