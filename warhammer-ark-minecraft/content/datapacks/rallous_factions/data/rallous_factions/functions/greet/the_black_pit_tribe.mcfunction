tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Black Pit — The Black Pit Tribe> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv The Black Pit Tribe. Then da boss might keep ya.", "color": "yellow"}]
