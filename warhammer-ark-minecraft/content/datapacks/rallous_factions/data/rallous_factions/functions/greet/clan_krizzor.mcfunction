tellraw @a[distance=..48] [{"text": "<Packmaster Krizzor — Clan Krizzor> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Krizzor. Then the Council hears.", "color": "yellow"}]
