tellraw @a[distance=..48] [{"text": "<Packmaster Krizzor — Clan Krizzor> ", "color": "light_purple", "bold": true}, {"text": "Moulder-cousins. Tribute in livestock. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_krizzor
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_krizzor
