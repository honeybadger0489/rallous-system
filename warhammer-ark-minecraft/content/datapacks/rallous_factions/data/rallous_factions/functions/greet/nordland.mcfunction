tellraw @a[distance=..48] [{"text": "<Elector Count of Nordland Theoderic Gausser — Nordland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Nordland soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
