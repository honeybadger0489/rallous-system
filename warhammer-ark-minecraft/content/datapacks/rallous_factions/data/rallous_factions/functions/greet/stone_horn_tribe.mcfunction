tellraw @a[distance=..48] [{"text": "<Doombull Stone-Horn — Stone-Horn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Highland herd. Prove you can bleed on a herdstone. This host does not treat crash-meat as a guest.", "color": "red"}]
