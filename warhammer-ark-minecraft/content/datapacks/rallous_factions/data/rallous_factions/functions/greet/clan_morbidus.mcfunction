tellraw @a[distance=..48] [{"text": "<Plague Priest Morbidus — Clan Morbidus> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Morbidus does not greet. Live the knives, or die-die.", "color": "red"}]
