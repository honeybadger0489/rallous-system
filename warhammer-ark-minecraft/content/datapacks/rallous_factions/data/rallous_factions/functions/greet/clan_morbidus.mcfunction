tellraw @a[distance=..48] [{"text": "<Plague Priest Morbidus — Clan Morbidus> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Morbidus. Then the Council hears.", "color": "yellow"}]
