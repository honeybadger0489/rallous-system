tellraw @a[distance=..48] [{"text": "<King of Karak Ziflin Ziflin — Karak Ziflin> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Ziflin names you clean, or be entered in the Book.", "color": "dark_purple"}]
