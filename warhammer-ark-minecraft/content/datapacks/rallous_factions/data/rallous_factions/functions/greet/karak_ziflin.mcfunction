tellraw @a[distance=..48] [{"text": "<King of Karak Ziflin Ziflin — Karak Ziflin> ", "color": "gold", "bold": true}, {"text": "Small western hold. Recruit rangers; keep the gate. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/karak_ziflin
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/karak_ziflin
