tellraw @a[distance=..48] [{"text": "<Assassin Treecherik — Clan Treecherik> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Treecherik does not greet. Live the knives, or die-die.", "color": "red"}]
