tellraw @a[distance=..48] [{"text": "<Assassin Treecherik — Clan Treecherik> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Treecherik. Then the Council hears.", "color": "yellow"}]
