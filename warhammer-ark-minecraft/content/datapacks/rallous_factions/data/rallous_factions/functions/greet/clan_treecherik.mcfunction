tellraw @a[distance=..48] [{"text": "<Assassin Treecherik — Clan Treecherik> ", "color": "light_purple", "bold": true}, {"text": "Backstab clan. Prove you expect betrayal. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_treecherik
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_treecherik
