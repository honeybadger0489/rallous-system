tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Red Eye — Red Eye> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Red Eye. Then da boss might keep ya.", "color": "yellow"}]
