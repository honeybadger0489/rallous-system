tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Red Eye — Red Eye> ", "color": "green", "bold": true}, {"text": "Karak Ungor squatters. War on anything dwarfen. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/red_eye
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/red_eye
