tellraw @a[distance=..48] [{"text": "<King of Karak Azorn Azorn — Karak Azorn> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Karak Azorn is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
