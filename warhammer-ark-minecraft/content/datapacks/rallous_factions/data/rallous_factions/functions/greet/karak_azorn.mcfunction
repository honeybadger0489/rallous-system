tellraw @a[distance=..48] [{"text": "<King of Karak Azorn Azorn — Karak Azorn> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Azorn names you clean, or be entered in the Book.", "color": "dark_purple"}]
