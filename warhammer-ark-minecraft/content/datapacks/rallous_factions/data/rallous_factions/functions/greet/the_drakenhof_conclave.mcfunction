tellraw @a[distance=..48] [{"text": "<Count of Sylvania Mannfred von Carstein — The Drakenhof Conclave> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of The Drakenhof Conclave do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
