tellraw @a[distance=..48] [{"text": "<Count of Sylvania Mannfred von Carstein — The Drakenhof Conclave> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of The Drakenhof Conclave. Then we may name you guest.", "color": "yellow"}]
