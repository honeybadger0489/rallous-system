tellraw @a[distance=..48] [{"text": "<Mage-Priest of the Mists Uaxti — Xlanhuapec> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Xlanhuapec will.", "color": "dark_purple"}]
