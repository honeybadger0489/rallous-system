tellraw @a[distance=..48] [{"text": "<King of Karak Azul Kazador Thunderhorn — Karak Azul> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Karak Azul is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
