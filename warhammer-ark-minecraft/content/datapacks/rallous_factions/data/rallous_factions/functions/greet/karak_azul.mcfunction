tellraw @a[distance=..48] [{"text": "<King of Karak Azul Kazador Thunderhorn — Karak Azul> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Azul names you clean, or be entered in the Book.", "color": "dark_purple"}]
