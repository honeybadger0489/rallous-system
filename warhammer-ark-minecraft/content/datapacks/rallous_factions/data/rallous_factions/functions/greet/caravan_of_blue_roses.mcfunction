tellraw @a[distance=..48] [{"text": "<The Red Duke The Red Duke — Caravan of Blue Roses> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Caravan of Blue Roses do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
