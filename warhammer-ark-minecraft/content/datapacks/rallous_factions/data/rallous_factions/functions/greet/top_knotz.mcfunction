tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Top Knot — Top Knotz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Top Knotz. Then da boss might keep ya.", "color": "yellow"}]
