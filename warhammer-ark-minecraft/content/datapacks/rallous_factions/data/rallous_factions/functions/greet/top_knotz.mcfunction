tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Top Knot — Top Knotz> ", "color": "green", "bold": true}, {"text": "Hair-tribe of the Southlands. Recruit wild boys. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/top_knotz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/top_knotz
