tellraw @a[distance=..48] [{"text": "<King of Karak Norn Brokk Ironpick — Karak Norn> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Norn names you clean, or be entered in the Book.", "color": "dark_purple"}]
