tellraw @a[distance=..48] [{"text": "<Beastlord Shadowgor — Shadowgor Warherd> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Shadowgor Warherd does not share this camp. Run, or be eaten.", "color": "red"}]
