tellraw @a[distance=..48] [{"text": "<Bray-Shaman Slugtongue's Kin — Manblight Tribe> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Manblight Tribe does not share this camp. Run, or be eaten.", "color": "red"}]
