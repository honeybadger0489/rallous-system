tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Gitilla's Cousin — Crooked Moon Mutinous Gits> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Crooked Moon Mutinous Gits. Then da boss might keep ya.", "color": "yellow"}]
