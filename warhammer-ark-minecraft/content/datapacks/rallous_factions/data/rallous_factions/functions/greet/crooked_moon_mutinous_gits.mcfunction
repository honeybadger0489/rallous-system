tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Gitilla's Cousin — Crooked Moon Mutinous Gits> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Crooked Moon Mutinous Gits. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/crooked_moon_mutinous_gits
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/crooked_moon_mutinous_gits
