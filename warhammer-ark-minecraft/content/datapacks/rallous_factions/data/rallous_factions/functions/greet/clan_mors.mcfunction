tellraw @a[distance=..48] [{"text": "<Warlord of Clan Mors Queek Headtaker — Clan Mors> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Mors. Then the Council hears.", "color": "yellow"}]
