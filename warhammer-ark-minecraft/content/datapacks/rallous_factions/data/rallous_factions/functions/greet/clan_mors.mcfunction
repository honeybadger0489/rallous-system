tellraw @a[distance=..48] [{"text": "<Warlord of Clan Mors Queek Headtaker — Clan Mors> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Mors does not greet. Live the knives, or die-die.", "color": "red"}]
