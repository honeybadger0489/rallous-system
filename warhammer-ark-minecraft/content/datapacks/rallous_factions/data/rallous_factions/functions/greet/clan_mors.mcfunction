tellraw @a[distance=..48] [{"text": "<Warlord of Clan Mors Queek Headtaker — Clan Mors> ", "color": "light_purple", "bold": true}, {"text": "Wants trophies. Prove you can take a head he has not already claimed. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_mors
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_mors
