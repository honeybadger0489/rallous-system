tellraw @a[distance=..48] [{"text": "<Exalted Hero of Khorne Son of Kharneth — Kharneth's Sons> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Kharneth's Sons, or die on this picket.", "color": "red"}]
