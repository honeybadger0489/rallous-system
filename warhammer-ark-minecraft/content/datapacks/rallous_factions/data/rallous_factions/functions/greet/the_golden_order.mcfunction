tellraw @a[distance=..48] [{"text": "<Supreme Patriarch Balthasar Gelt — The Golden Order> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto The Golden Order soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
