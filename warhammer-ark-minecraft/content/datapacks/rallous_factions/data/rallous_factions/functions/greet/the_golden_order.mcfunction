tellraw @a[distance=..48] [{"text": "<Supreme Patriarch Balthasar Gelt — The Golden Order> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto The Golden Order soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
