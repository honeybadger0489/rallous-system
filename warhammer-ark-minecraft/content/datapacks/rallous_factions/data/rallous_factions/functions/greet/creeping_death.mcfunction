tellraw @a[distance=..48] [{"text": "<Forest Goblin Warboss Creeping Death — Creeping Death> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Creeping Death. Then da boss might keep ya.", "color": "yellow"}]
