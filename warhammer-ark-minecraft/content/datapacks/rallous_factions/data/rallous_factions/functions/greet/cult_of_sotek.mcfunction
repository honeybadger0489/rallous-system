tellraw @a[distance=..48] [{"text": "<Prophet of Sotek Tehenhauin — Cult of Sotek> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Cult of Sotek is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
