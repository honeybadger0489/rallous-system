tellraw @a[distance=..48] [{"text": "<Elector Count of Ostermark Wolfram Hertwig — Ostermark> ", "color": "red", "bold": true}, {"text": "Marcher count on the dead border. Help hold the east or get off his road. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
