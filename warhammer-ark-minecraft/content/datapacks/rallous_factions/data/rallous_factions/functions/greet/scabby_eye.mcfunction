tellraw @a[distance=..48] [{"text": "<Goblin Warboss Scabby Eye — Scabby Eye> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Scabby Eye. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/scabby_eye
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/scabby_eye
