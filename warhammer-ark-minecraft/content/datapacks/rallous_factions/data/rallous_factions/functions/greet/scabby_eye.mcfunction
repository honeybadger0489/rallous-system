tellraw @a[distance=..48] [{"text": "<Goblin Warboss Scabby Eye — Scabby Eye> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Scabby Eye. Then da boss might keep ya.", "color": "yellow"}]
