tellraw @a[distance=..48] [{"text": "<Skink Oracle Xeti-Watcher — Sentinels of Xeti> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Sentinels of Xeti is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/sentinels_of_xeti
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/sentinels_of_xeti
