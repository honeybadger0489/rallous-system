tellraw @a[distance=..48] [{"text": "<Skink Oracle Xeti-Watcher — Sentinels of Xeti> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Sentinels of Xeti will.", "color": "dark_purple"}]
