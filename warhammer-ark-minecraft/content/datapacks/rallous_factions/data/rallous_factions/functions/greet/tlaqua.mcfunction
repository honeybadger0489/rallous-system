tellraw @a[distance=..48] [{"text": "<Master of Skies Tiktaq'to — Tlaqua> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Tlaqua is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
