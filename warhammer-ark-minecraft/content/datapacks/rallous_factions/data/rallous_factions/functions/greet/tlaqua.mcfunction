tellraw @a[distance=..48] [{"text": "<Master of Skies Tiktaq'to — Tlaqua> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Tlaqua will.", "color": "dark_purple"}]
