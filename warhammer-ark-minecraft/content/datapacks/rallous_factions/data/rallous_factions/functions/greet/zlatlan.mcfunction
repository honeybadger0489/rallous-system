tellraw @a[distance=..48] [{"text": "<Oldblood of Zlatlan Zlatanq — Zlatlan> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Zlatlan is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
