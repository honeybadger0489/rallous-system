tellraw @a[distance=..48] [{"text": "<Orc Warboss Cage-Breaka — Da Cage Breakaz> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Da Cage Breakaz. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
