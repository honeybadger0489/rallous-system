tellraw @a[distance=..48] [{"text": "<Orc Warboss Cage-Breaka — Da Cage Breakaz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Da Cage Breakaz. Then da boss might keep ya.", "color": "yellow"}]
