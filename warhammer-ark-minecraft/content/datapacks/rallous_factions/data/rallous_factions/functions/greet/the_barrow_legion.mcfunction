tellraw @a[distance=..48] [{"text": "<Lichemaster Heinrich Kemmler — The Barrow Legion> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of The Barrow Legion do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
