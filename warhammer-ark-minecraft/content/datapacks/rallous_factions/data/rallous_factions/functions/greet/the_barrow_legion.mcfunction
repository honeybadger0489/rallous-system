tellraw @a[distance=..48] [{"text": "<Lichemaster Heinrich Kemmler — The Barrow Legion> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of The Barrow Legion. Then we may name you guest.", "color": "yellow"}]
