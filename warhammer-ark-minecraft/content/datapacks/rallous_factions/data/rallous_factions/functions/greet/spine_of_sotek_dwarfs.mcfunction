tellraw @a[distance=..48] [{"text": "<Thane Sotek-Spine — Spine of Sotek Dwarfs> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Spine of Sotek Dwarfs is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
