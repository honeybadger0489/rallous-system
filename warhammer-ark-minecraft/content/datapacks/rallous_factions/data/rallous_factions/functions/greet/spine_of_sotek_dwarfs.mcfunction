tellraw @a[distance=..48] [{"text": "<Thane Sotek-Spine — Spine of Sotek Dwarfs> ", "color": "gold", "bold": true}, {"text": "Lustrian prospectors. Help if you keep lizards off the claim. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/spine_of_sotek_dwarfs
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/spine_of_sotek_dwarfs
