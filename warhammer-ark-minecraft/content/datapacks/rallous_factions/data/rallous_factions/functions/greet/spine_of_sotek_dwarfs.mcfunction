tellraw @a[distance=..48] [{"text": "<Thane Sotek-Spine — Spine of Sotek Dwarfs> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Spine of Sotek Dwarfs names you clean, or be entered in the Book.", "color": "dark_purple"}]
