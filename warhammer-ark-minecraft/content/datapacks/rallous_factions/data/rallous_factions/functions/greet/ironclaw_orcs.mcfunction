tellraw @a[distance=..48] [{"text": "<Orc Warboss Gorbad Ironclaw — Ironclaw Orcs> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Ironclaw Orcs. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
