tellraw @a[distance=..48] [{"text": "<Orc Warboss Gorbad Ironclaw — Ironclaw Orcs> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Ironclaw Orcs. Then da boss might keep ya.", "color": "yellow"}]
