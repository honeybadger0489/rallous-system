tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Leaf-Cutter — Leaf-Cutterz Tribe> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Leaf-Cutterz Tribe. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
