tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Leaf-Cutter — Leaf-Cutterz Tribe> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Leaf-Cutterz Tribe. Then da boss might keep ya.", "color": "yellow"}]
