tellraw @a[distance=..48] [{"text": "<Orc Warboss Da Chain-Breaka — Broken Chainz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Broken Chainz. Then da boss might keep ya.", "color": "yellow"}]
