tellraw @a[distance=..48] [{"text": "<Orc Warboss Da Chain-Breaka — Broken Chainz> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Broken Chainz. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
