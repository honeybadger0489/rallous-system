tellraw @a[distance=..48] [{"text": "<Orc Warboss Da Chain-Breaka — Broken Chainz> ", "color": "green", "bold": true}, {"text": "Escaped slaves. Recruit anyone who hates collars. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/broken_chainz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/broken_chainz
