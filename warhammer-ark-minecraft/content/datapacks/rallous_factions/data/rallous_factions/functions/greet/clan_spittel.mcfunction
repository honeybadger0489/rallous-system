tellraw @a[distance=..48] [{"text": "<Plague Priest Spittel — Clan Spittel> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Spittel does not greet. Live the knives, or die-die.", "color": "red"}]
