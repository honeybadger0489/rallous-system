tellraw @a[distance=..48] [{"text": "<Plague Priest Spittel — Clan Spittel> ", "color": "light_purple", "bold": true}, {"text": "Lustria pox-burrow. War on spawning pools. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_spittel
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_spittel
