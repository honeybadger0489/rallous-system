tellraw @a[distance=..48] [{"text": "<Plague Priest Spittel — Clan Spittel> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Spittel. Then the Council hears.", "color": "yellow"}]
