tellraw @a[distance=..48] [{"text": "<Orc Warboss Skull Crag — Skull Crag> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Skull Crag. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/skull_crag
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/skull_crag
