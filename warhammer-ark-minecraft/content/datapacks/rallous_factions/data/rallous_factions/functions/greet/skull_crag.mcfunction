tellraw @a[distance=..48] [{"text": "<Orc Warboss Skull Crag — Skull Crag> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Skull Crag. Then da boss might keep ya.", "color": "yellow"}]
