tellraw @a[distance=..48] [{"text": "<The Hidden Oxyotl — Ghosts of Pahuax> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Ghosts of Pahuax is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
