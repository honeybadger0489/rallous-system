tellraw @a[distance=..48] [{"text": "<High King of the Karaz Ankor Thorgrim Grudgebearer — Karaz-a-Karak> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Karaz-a-Karak is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
