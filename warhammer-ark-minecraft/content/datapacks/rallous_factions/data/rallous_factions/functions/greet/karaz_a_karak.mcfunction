tellraw @a[distance=..48] [{"text": "<High King of the Karaz Ankor Thorgrim Grudgebearer — Karaz-a-Karak> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karaz-a-Karak names you clean, or be entered in the Book.", "color": "dark_purple"}]
