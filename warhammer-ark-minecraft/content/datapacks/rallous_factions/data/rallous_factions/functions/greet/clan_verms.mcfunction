tellraw @a[distance=..48] [{"text": "<Packmaster Verms — Clan Verms> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Verms does not greet. Live the knives, or die-die.", "color": "red"}]
