tellraw @a[distance=..48] [{"text": "<The Shadowgave Morghur — Warherd of the Shadowgave> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Warherd of the Shadowgave does not share this camp. Run, or be eaten.", "color": "red"}]
