tellraw @a[distance=..48] [{"text": "<The Shadowgave Morghur — Warherd of the Shadowgave> ", "color": "dark_green", "bold": true}, {"text": "Corruption incarnate. Tames become spawn. No diplomacy. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/warherd_of_the_shadowgave
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/warherd_of_the_shadowgave
