tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Dimmed Sun — Dimmed Sunz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Dimmed Sunz. Then da boss might keep ya.", "color": "yellow"}]
