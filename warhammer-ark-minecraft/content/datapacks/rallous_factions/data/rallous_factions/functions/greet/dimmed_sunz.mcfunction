tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Dimmed Sun — Dimmed Sunz> ", "color": "green", "bold": true}, {"text": "Eclipse-painted tribe. War under a bad sky. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/dimmed_sunz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/dimmed_sunz
