tellraw @a[distance=..48] [{"text": "<King of Karak Hirn Alrik Ranulfsson — Karak Hirn> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Hirn names you clean, or be entered in the Book.", "color": "dark_purple"}]
