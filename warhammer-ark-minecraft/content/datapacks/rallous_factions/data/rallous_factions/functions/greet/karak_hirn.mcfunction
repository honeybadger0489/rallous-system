tellraw @a[distance=..48] [{"text": "<King of Karak Hirn Alrik Ranulfsson — Karak Hirn> ", "color": "gold", "bold": true}, {"text": "Hornhold on the Empire border. Tribute in ore-contracts if you want passage. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/karak_hirn
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/karak_hirn
