tellraw @a[distance=..48] [{"text": "<King of Karak Hirn Alrik Ranulfsson — Karak Hirn> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Karak Hirn is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
