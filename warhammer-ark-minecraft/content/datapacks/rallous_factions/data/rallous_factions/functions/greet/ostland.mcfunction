tellraw @a[distance=..48] [{"text": "<Elector Count of Ostland Valmir von Raukov — Ostland> ", "color": "red", "bold": true}, {"text": "Hard northern elector. Daemon-stink gets a pyre; useful blades get a ration. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/ostland
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/ostland
