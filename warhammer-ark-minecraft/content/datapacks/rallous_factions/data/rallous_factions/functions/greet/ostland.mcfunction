tellraw @a[distance=..48] [{"text": "<Elector Count of Ostland Valmir von Raukov — Ostland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Ostland soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
