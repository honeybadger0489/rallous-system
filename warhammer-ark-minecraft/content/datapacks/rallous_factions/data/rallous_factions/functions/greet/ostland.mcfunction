tellraw @a[distance=..48] [{"text": "<Elector Count of Ostland Valmir von Raukov — Ostland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Ostland soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
