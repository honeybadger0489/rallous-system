tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Moon Howler — Moon Howlerz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Moon Howlerz. Then da boss might keep ya.", "color": "yellow"}]
