tellraw @a[distance=..48] [{"text": "<Lahmian Mistress Neferata's Hand — Lahmian Sisterhood> ", "color": "dark_red", "bold": true}, {"text": "Court poison and soft words. Prove discretion; she will use your warband as a knife. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/lahmian_sisterhood
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/lahmian_sisterhood
