tellraw @a[distance=..48] [{"text": "<Lahmian Mistress Neferata's Hand — Lahmian Sisterhood> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Lahmian Sisterhood do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
