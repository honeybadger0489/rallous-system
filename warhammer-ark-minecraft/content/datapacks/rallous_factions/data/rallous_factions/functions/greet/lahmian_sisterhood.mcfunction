tellraw @a[distance=..48] [{"text": "<Lahmian Mistress Neferata's Hand — Lahmian Sisterhood> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Lahmian Sisterhood. Then we may name you guest.", "color": "yellow"}]
