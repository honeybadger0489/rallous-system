tellraw @a[distance=..48] [{"text": "<Warlord Carrion-Take — Clan Carrion> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Carrion does not greet. Live the knives, or die-die.", "color": "red"}]
