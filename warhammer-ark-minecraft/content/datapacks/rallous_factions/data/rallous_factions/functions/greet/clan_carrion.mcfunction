tellraw @a[distance=..48] [{"text": "<Warlord Carrion-Take — Clan Carrion> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Carrion. Then the Council hears.", "color": "yellow"}]
