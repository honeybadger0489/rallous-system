tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Grimgor Ironhide — Grimgor's 'Ardboyz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Grimgor's 'Ardboyz. Then da boss might keep ya.", "color": "yellow"}]
