tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Grimgor Ironhide — Grimgor's 'Ardboyz> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Grimgor's 'Ardboyz. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
