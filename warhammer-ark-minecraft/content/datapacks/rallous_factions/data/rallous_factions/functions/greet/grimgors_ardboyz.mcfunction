tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Grimgor Ironhide — Grimgor's 'Ardboyz> ", "color": "green", "bold": true}, {"text": "Grimgor iz da best. Must prove it in a scrap or get in line. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/grimgors_ardboyz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/grimgors_ardboyz
