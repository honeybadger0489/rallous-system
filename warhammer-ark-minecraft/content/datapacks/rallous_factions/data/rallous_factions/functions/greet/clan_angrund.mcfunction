tellraw @a[distance=..48] [{"text": "<King of Karak Eight Peaks Belegar Ironhammer — Clan Angrund> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Clan Angrund names you clean, or be entered in the Book.", "color": "dark_purple"}]
