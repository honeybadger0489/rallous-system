tellraw @a[distance=..48] [{"text": "<King of Karak Eight Peaks Belegar Ironhammer — Clan Angrund> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Clan Angrund is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
