tellraw @a[distance=..48] [{"text": "<Thane Helhein — Clan Helhein> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Clan Helhein names you clean, or be entered in the Book.", "color": "dark_purple"}]
