tellraw @a[distance=..48] [{"text": "<Thane Helhein — Clan Helhein> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Clan Helhein is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
