tellraw @a[distance=..48] [{"text": "<Elector Count of Averland Marius Leitdorf — Averland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Averland soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
