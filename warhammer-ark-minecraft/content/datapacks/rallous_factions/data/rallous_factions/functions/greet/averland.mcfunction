tellraw @a[distance=..48] [{"text": "<Elector Count of Averland Marius Leitdorf — Averland> ", "color": "red", "bold": true}, {"text": "Erratic but generous to riders and pistoliers who keep the pass open. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/averland
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/averland
