tellraw @a[distance=..48] [{"text": "<Slayer King Ungrim Ironfist — Karak Kadrin> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Karak Kadrin is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
