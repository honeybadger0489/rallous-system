tellraw @a[distance=..48] [{"text": "<Slayer King Ungrim Ironfist — Karak Kadrin> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Karak Kadrin names you clean, or be entered in the Book.", "color": "dark_purple"}]
