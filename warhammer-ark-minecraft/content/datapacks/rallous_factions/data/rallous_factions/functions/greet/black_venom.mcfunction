tellraw @a[distance=..48] [{"text": "<Forest Goblin Warboss Black Venom — Black Venom> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Black Venom. Then da boss might keep ya.", "color": "yellow"}]
