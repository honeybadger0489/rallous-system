tellraw @a[distance=..48] [{"text": "<Forest Goblin Warboss Black Venom — Black Venom> ", "color": "green", "bold": true}, {"text": "Poison-tribe. Tribute in captives for the spiders. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/black_venom
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/black_venom
