tellraw @a[distance=..48] [{"text": "<Forest Goblin Warboss Black Venom — Black Venom> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Black Venom. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
