tellraw @a[distance=..48] [{"text": "<Duke of Mousillon Maldred's Heir — Mousillon> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Mousillon. Then we may name you guest.", "color": "yellow"}]
