tellraw @a[distance=..48] [{"text": "<Duke of Mousillon Maldred's Heir — Mousillon> ", "color": "dark_red", "bold": true}, {"text": "Cursed Bretonnian night-court. Help against the living dukes or be listed as prey. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/mousillon
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/mousillon
