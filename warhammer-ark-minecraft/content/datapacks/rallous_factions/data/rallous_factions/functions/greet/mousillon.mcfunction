tellraw @a[distance=..48] [{"text": "<Duke of Mousillon Maldred's Heir — Mousillon> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Mousillon do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
