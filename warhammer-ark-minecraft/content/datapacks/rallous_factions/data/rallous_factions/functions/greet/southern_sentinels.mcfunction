tellraw @a[distance=..48] [{"text": "<Saurus Oldblood Lotl of the South — Southern Sentinels> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Southern Sentinels is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
