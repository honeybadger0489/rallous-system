tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Skull-taka — Skull-takerz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Skull-takerz. Then da boss might keep ya.", "color": "yellow"}]
