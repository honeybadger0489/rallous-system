tellraw @a[distance=..48] [{"text": "<Goblin Warboss Red Cloud — Red Cloud> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Red Cloud. Then da boss might keep ya.", "color": "yellow"}]
