tellraw @a[distance=..48] [{"text": "<Goblin Warboss Red Cloud — Red Cloud> ", "color": "green", "bold": true}, {"text": "Wolf-riders of the east. Recruit scouts. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/red_cloud
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/red_cloud
