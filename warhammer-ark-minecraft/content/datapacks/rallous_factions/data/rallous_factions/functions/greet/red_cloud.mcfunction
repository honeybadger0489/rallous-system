tellraw @a[distance=..48] [{"text": "<Goblin Warboss Red Cloud — Red Cloud> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Red Cloud. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
