tellraw @a[distance=..48] [{"text": "<Deathmaster Deathmaster Snikch — Clan Eshin> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Eshin does not greet. Live the knives, or die-die.", "color": "red"}]
