tellraw @a[distance=..48] [{"text": "<Deathmaster Deathmaster Snikch — Clan Eshin> ", "color": "light_purple", "bold": true}, {"text": "Contracts only. Prove silence; then recruit as a knife. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
