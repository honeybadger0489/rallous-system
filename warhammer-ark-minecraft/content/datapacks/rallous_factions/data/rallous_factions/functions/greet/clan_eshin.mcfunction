tellraw @a[distance=..48] [{"text": "<Deathmaster Deathmaster Snikch — Clan Eshin> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Eshin. Then the Council hears.", "color": "yellow"}]
