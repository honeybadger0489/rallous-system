tellraw @a[distance=..48] [{"text": "<Necrarch Master Melkhior the Ancient — Necrarch Brotherhood> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Necrarch Brotherhood. Then we may name you guest.", "color": "yellow"}]
