tellraw @a[distance=..48] [{"text": "<Necrarch Master Melkhior the Ancient — Necrarch Brotherhood> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Necrarch Brotherhood do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
