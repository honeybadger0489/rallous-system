tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Drippin Fangs — Drippin Fangs> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Drippin Fangs. Then da boss might keep ya.", "color": "yellow"}]
