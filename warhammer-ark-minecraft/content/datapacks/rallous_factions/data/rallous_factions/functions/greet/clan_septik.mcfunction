tellraw @a[distance=..48] [{"text": "<Plague Priest Septik — Clan Septik> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Septik does not greet. Live the knives, or die-die.", "color": "red"}]
