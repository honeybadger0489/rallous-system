tellraw @a[distance=..48] [{"text": "<Plague Priest Septik — Clan Septik> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Septik. Then the Council hears.", "color": "yellow"}]
