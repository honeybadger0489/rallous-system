tellraw @a[distance=..48] [{"text": "<The Undefeated Arbaal the Undefeated — Challengers of Khorne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Challengers of Khorne, or die on this picket.", "color": "red"}]
