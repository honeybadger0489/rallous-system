tellraw @a[distance=..48] [{"text": "<The Undefeated Arbaal the Undefeated — Challengers of Khorne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Challengers of Khorne does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/challengers_of_khorne
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/challengers_of_khorne
