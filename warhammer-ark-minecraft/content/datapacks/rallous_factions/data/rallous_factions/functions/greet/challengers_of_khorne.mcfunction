tellraw @a[distance=..48] [{"text": "<The Undefeated Arbaal the Undefeated — Challengers of Khorne> ", "color": "dark_red", "bold": true}, {"text": "Issues challenges. Prove in single combat or be listed as coward-meat. This host does not treat crash-meat as a guest.", "color": "red"}]
