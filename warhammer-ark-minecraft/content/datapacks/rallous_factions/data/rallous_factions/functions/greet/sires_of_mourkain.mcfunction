tellraw @a[distance=..48] [{"text": "<Strigoi King Ushoran's Get — Sires of Mourkain> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Sires of Mourkain do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
