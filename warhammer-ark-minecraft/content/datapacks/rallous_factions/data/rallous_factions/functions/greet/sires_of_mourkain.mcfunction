tellraw @a[distance=..48] [{"text": "<Strigoi King Ushoran's Get — Sires of Mourkain> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Sires of Mourkain. Then we may name you guest.", "color": "yellow"}]
