tellraw @a[distance=..48] [{"text": "<Strigoi King Ushoran's Get — Sires of Mourkain> ", "color": "dark_red", "bold": true}, {"text": "Ruined dynasty. War first; the living are cattle until a city is raised again. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/sires_of_mourkain
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/sires_of_mourkain
