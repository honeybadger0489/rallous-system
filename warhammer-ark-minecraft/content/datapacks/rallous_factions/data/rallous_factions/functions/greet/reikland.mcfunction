tellraw @a[distance=..48] [{"text": "<Prince of Altdorf, Emperor Karl Franz — Reikland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Reikland soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
