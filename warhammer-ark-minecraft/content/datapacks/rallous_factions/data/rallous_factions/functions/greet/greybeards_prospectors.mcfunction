tellraw @a[distance=..48] [{"text": "<Thane Greybeard — Greybeard's Prospectors> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Greybeard's Prospectors is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/greybeards_prospectors
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/greybeards_prospectors
