tellraw @a[distance=..48] [{"text": "<Thane Greybeard — Greybeard's Prospectors> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Greybeard's Prospectors names you clean, or be entered in the Book.", "color": "dark_purple"}]
