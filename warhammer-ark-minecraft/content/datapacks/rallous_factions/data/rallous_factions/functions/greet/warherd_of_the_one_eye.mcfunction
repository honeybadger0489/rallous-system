tellraw @a[distance=..48] [{"text": "<Beastlord Khazrak the One-Eye — Warherd of the One-Eye> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Warherd of the One-Eye does not share this camp. Run, or be eaten.", "color": "red"}]
