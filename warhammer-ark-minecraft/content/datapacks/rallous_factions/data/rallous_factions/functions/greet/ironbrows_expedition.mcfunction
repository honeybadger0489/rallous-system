tellraw @a[distance=..48] [{"text": "<Runelord Thorek Ironbrow — Ironbrow's Expedition> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Ironbrow's Expedition names you clean, or be entered in the Book.", "color": "dark_purple"}]
