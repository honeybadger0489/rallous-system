tellraw @a[distance=..48] [{"text": "<Runelord Thorek Ironbrow — Ironbrow's Expedition> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Ironbrow's Expedition is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
