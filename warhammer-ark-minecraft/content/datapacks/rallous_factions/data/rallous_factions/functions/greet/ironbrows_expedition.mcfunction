tellraw @a[distance=..48] [{"text": "<Runelord Thorek Ironbrow — Ironbrow's Expedition> ", "color": "gold", "bold": true}, {"text": "Recovering relics. Help haul an anvil; daemon-toys get a rune-hammer. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/ironbrows_expedition
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/ironbrows_expedition
