tellraw @a[distance=..48] [{"text": "<Lord of Hexoatl Lord Mazdamundi — Hexoatl> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Hexoatl is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
