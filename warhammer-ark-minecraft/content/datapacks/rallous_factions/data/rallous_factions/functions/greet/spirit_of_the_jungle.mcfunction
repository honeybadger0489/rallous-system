tellraw @a[distance=..48] [{"text": "<The Wanderer Nakai the Wanderer — Spirit of the Jungle> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Spirit of the Jungle will.", "color": "dark_purple"}]
