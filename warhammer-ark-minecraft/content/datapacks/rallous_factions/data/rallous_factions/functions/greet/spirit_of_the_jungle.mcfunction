tellraw @a[distance=..48] [{"text": "<The Wanderer Nakai the Wanderer — Spirit of the Jungle> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Spirit of the Jungle is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
