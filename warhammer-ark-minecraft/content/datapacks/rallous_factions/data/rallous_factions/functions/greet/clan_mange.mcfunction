tellraw @a[distance=..48] [{"text": "<Chieftain Mange — Clan Mange> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Mange does not greet. Live the knives, or die-die.", "color": "red"}]
