tellraw @a[distance=..48] [{"text": "<Chieftain Mange — Clan Mange> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Mange. Then the Council hears.", "color": "yellow"}]
