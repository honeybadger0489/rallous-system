tellraw @a[distance=..48] [{"text": "<Herald of Khorne Bloody Sword — Bloody Sword> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Bloody Sword does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/bloody_sword
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/bloody_sword
