tellraw @a[distance=..48] [{"text": "<Herald of Khorne Bloody Sword — Bloody Sword> ", "color": "dark_red", "bold": true}, {"text": "Roaming brass host. War is the only offer. This host does not treat crash-meat as a guest.", "color": "red"}]
