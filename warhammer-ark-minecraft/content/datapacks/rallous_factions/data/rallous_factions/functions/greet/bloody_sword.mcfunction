tellraw @a[distance=..48] [{"text": "<Herald of Khorne Bloody Sword — Bloody Sword> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Bloody Sword, or die on this picket.", "color": "red"}]
