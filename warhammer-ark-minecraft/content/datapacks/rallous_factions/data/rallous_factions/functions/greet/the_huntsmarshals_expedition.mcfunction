tellraw @a[distance=..48] [{"text": "<Huntsmarshal of the Empire Markus Wulfhart — The Huntsmarshal's Expedition> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto The Huntsmarshal's Expedition soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
