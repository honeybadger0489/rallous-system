tellraw @a[distance=..48] [{"text": "<The White Dwarf Grombrindal — The Ancestral Throng> ", "color": "gold", "bold": true}, {"text": "Ancestor on campaign. Prove you keep an oath; he will stand in the shield wall. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/the_ancestral_throng
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/the_ancestral_throng
