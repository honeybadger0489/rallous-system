tellraw @a[distance=..48] [{"text": "<The White Dwarf Grombrindal — The Ancestral Throng> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. The Ancestral Throng is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
