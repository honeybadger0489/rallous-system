tellraw @a[distance=..48] [{"text": "<The White Dwarf Grombrindal — The Ancestral Throng> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until The Ancestral Throng names you clean, or be entered in the Book.", "color": "dark_purple"}]
