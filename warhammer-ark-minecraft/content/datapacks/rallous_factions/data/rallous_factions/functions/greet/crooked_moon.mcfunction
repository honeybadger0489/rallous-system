tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Skarsnik — Crooked Moon> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Crooked Moon. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
