tellraw @a[distance=..48] [{"text": "<Wargor Skrinderkin — Skrinderkin Warherd> ", "color": "dark_green", "bold": true}, {"text": "Lustrian herd. Tribute in beasts you failed to keep tame. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/skrinderkin_warherd
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/skrinderkin_warherd
