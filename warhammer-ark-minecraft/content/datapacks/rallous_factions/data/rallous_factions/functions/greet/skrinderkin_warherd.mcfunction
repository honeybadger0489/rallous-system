tellraw @a[distance=..48] [{"text": "<Wargor Skrinderkin — Skrinderkin Warherd> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Skrinderkin Warherd does not share this camp. Run, or be eaten.", "color": "red"}]
