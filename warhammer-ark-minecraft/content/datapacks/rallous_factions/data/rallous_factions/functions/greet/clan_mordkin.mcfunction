tellraw @a[distance=..48] [{"text": "<Warlord Mordkin — Clan Mordkin> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Mordkin. Then the Council hears.", "color": "yellow"}]
