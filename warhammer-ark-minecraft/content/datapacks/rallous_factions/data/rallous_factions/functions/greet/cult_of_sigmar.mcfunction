tellraw @a[distance=..48] [{"text": "<Grand Theogonist Volkmar the Grim — Cult of Sigmar> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Cult of Sigmar soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
