tellraw @a[distance=..48] [{"text": "<Grand Theogonist Volkmar the Grim — Cult of Sigmar> ", "color": "red", "bold": true}, {"text": "Faith first. A Warp-stranger may carry a hammer if they take the comet-oath. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/cult_of_sigmar
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/cult_of_sigmar
