tellraw @a[distance=..48] [{"text": "<Grand Theogonist Volkmar the Grim — Cult of Sigmar> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Cult of Sigmar soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
