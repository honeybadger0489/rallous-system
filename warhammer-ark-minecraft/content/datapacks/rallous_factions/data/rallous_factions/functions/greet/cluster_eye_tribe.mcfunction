tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Cluster-Eye — Cluster-Eye Tribe> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Cluster-Eye Tribe. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/cluster_eye_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/cluster_eye_tribe
