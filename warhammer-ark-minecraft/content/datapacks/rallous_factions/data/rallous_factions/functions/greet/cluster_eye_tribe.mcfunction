tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Cluster-Eye — Cluster-Eye Tribe> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Cluster-Eye Tribe. Then da boss might keep ya.", "color": "yellow"}]
