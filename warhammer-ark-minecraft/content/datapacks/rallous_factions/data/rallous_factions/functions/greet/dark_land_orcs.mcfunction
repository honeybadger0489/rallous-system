tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Durkol da Dark — Dark Land Orcs> ", "color": "green", "bold": true}, {"text": "Ash-plain orcs. War on anything that looks rich. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/dark_land_orcs
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/dark_land_orcs
