tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Durkol da Dark — Dark Land Orcs> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Dark Land Orcs. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
