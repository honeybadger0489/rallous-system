tellraw @a[distance=..48] [{"text": "<Black Orc Warboss Durkol da Dark — Dark Land Orcs> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Dark Land Orcs. Then da boss might keep ya.", "color": "yellow"}]
