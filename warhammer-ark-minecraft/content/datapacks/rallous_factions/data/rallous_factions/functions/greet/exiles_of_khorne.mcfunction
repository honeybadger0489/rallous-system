tellraw @a[distance=..48] [{"text": "<The Exiled Skarbrand the Exiled — Exiles of Khorne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Exiles of Khorne does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
