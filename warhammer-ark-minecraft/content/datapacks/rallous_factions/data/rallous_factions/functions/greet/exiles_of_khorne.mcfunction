tellraw @a[distance=..48] [{"text": "<The Exiled Skarbrand the Exiled — Exiles of Khorne> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Exiles of Khorne, or die on this picket.", "color": "red"}]
