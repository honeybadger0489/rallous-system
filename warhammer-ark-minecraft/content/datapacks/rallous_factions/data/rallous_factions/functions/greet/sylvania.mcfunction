tellraw @a[distance=..48] [{"text": "<Vampire Count of Sylvania Vlad von Carstein — Sylvania> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Sylvania do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
