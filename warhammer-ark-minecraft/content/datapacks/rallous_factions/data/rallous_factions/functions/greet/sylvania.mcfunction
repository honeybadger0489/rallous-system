tellraw @a[distance=..48] [{"text": "<Vampire Count of Sylvania Vlad von Carstein — Sylvania> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Sylvania. Then we may name you guest.", "color": "yellow"}]
