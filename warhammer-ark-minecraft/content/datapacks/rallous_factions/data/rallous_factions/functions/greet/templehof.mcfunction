tellraw @a[distance=..48] [{"text": "<Count of Templehof Nicodemus von Templehof — Templehof> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Templehof. Then we may name you guest.", "color": "yellow"}]
