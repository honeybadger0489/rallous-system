tellraw @a[distance=..48] [{"text": "<Count of Templehof Nicodemus von Templehof — Templehof> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Templehof do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
