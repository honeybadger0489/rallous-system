tellraw @a[distance=..48] [{"text": "<Slann Mage-Priest Tenehuini of Tepok — Tepok's Spawn> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Tepok's Spawn will.", "color": "dark_purple"}]
