tellraw @a[distance=..48] [{"text": "<Slann Mage-Priest Tenehuini of Tepok — Tepok's Spawn> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Tepok's Spawn is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
