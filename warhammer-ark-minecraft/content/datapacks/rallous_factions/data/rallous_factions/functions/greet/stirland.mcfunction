tellraw @a[distance=..48] [{"text": "<Elector Count of Stirland Alberich Haupt-Anderssen — Stirland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Stirland soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
