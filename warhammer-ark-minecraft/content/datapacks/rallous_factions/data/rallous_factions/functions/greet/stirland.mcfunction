tellraw @a[distance=..48] [{"text": "<Elector Count of Stirland Alberich Haupt-Anderssen — Stirland> ", "color": "red", "bold": true}, {"text": "Superstitious Sigmarite neighbour of Sylvania. Cult-adjacent: hates the night courts. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/stirland
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/stirland
