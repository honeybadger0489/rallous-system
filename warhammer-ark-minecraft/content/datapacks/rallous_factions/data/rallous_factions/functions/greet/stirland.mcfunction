tellraw @a[distance=..48] [{"text": "<Elector Count of Stirland Alberich Haupt-Anderssen — Stirland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Stirland soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
