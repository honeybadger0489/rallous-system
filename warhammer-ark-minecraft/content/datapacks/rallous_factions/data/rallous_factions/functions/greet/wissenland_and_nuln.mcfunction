tellraw @a[distance=..48] [{"text": "<Elector Countess of Wissenland Elspeth von Draken — Wissenland & Nuln> ", "color": "red", "bold": true}, {"text": "Amethyst pragmatist: coin, blackpowder, and no sentiment for Warp-born pets. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/wissenland_and_nuln
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/wissenland_and_nuln
