tellraw @a[distance=..48] [{"text": "<Elector Countess of Wissenland Elspeth von Draken — Wissenland & Nuln> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Wissenland & Nuln soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
