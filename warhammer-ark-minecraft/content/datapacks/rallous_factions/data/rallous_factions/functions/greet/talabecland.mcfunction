tellraw @a[distance=..48] [{"text": "<Elector Count of Talabecland Helmut Feuerbach — Talabecland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Talabecland soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
