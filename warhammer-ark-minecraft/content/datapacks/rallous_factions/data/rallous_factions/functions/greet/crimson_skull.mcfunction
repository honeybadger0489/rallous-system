tellraw @a[distance=..48] [{"text": "<Skullmaster Crimson Skull — Crimson Skull> ", "color": "dark_red", "bold": true}, {"text": "Skull-harvest riders. Recruit only the already-blooded. This host does not treat crash-meat as a guest.", "color": "red"}]
