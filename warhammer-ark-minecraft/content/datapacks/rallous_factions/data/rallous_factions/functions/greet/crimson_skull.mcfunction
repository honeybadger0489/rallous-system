tellraw @a[distance=..48] [{"text": "<Skullmaster Crimson Skull — Crimson Skull> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Crimson Skull does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
