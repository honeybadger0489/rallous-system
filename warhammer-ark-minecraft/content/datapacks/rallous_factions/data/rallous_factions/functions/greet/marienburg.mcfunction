tellraw @a[distance=..48] [{"text": "<Director of Marienburg Leopold van Haagen — Marienburg> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Marienburg soil. Take a blade. Fight with us — hold this road, or be meat for the next banner.", "color": "white"}]
