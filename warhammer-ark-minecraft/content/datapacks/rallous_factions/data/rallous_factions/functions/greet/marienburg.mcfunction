tellraw @a[distance=..48] [{"text": "<Director of Marienburg Leopold van Haagen — Marienburg> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Marienburg soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
