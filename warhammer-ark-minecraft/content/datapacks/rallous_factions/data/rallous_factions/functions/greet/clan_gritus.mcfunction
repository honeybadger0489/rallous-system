tellraw @a[distance=..48] [{"text": "<Warlord Gritus — Clan Gritus> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Gritus does not greet. Live the knives, or die-die.", "color": "red"}]
