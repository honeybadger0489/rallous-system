tellraw @a[distance=..48] [{"text": "<Warlord Gritus — Clan Gritus> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Gritus. Then the Council hears.", "color": "yellow"}]
