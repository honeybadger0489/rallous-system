tellraw @a[distance=..48] [{"text": "<Jiangshi Lord Prince Jiang — Jiangshi Rebels> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of Jiangshi Rebels do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
