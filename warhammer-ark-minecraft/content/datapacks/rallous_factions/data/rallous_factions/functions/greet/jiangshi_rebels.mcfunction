tellraw @a[distance=..48] [{"text": "<Jiangshi Lord Prince Jiang — Jiangshi Rebels> ", "color": "dark_red", "bold": true}, {"text": "Cathayan dead in revolt. Tribute in bodies; no treaties with the Mandate. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/jiangshi_rebels
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/jiangshi_rebels
