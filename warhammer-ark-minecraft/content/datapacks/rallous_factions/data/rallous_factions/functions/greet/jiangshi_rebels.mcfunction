tellraw @a[distance=..48] [{"text": "<Jiangshi Lord Prince Jiang — Jiangshi Rebels> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of Jiangshi Rebels. Then we may name you guest.", "color": "yellow"}]
