tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Blue Viper — Blue Vipers> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Blue Vipers. Then da boss might keep ya.", "color": "yellow"}]
