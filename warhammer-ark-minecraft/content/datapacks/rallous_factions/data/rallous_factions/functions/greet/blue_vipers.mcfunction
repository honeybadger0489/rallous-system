tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Blue Viper — Blue Vipers> ", "color": "green", "bold": true}, {"text": "Southlands savages. Prove in a painted scrap. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/blue_vipers
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/blue_vipers
