tellraw @a[distance=..48] [{"text": "<Elector Count of Hochland Aldebrand Ludenhof — Hochland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Hochland soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
