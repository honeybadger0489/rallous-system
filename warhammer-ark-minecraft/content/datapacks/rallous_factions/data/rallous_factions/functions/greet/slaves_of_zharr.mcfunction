tellraw @a[distance=..48] [{"text": "<Orc Warboss Still-Chained Urk — Slaves of Zharr> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Slaves of Zharr. Then da boss might keep ya.", "color": "yellow"}]
