tellraw @a[distance=..48] [{"text": "<Orc Warboss Still-Chained Urk — Slaves of Zharr> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Slaves of Zharr. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
