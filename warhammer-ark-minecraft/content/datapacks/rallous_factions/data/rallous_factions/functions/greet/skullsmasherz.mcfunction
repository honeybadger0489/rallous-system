tellraw @a[distance=..48] [{"text": "<Orc Warboss Skullsmash — Skullsmasherz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Skullsmasherz. Then da boss might keep ya.", "color": "yellow"}]
