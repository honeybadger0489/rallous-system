tellraw @a[distance=..48] [{"text": "<Orc Warboss Skullsmash — Skullsmasherz> ", "color": "green", "bold": true}, {"text": "Simple politics: smash skulls. Prove yours is harder. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/skullsmasherz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/skullsmasherz
