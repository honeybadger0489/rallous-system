tellraw @a[distance=..48] [{"text": "<Orc Warboss Skullsmash — Skullsmasherz> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Skullsmasherz. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
