tellraw @a[distance=..48] [{"text": "<Goblin Warboss Grom the Paunch — Broken Axe> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Broken Axe. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
