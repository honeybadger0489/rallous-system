tellraw @a[distance=..48] [{"text": "<King of Barak Varr Byrrnoth Grundadrakk — Barak Varr> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Barak Varr names you clean, or be entered in the Book.", "color": "dark_purple"}]
