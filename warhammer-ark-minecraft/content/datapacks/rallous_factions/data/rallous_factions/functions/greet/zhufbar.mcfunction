tellraw @a[distance=..48] [{"text": "<King of Zhufbar Barundin Stoneheart — Zhufbar> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Zhufbar names you clean, or be entered in the Book.", "color": "dark_purple"}]
