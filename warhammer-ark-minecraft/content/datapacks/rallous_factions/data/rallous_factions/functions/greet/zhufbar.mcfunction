tellraw @a[distance=..48] [{"text": "<King of Zhufbar Barundin Stoneheart — Zhufbar> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Zhufbar is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
