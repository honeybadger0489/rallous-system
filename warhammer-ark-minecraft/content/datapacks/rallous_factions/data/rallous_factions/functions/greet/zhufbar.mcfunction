tellraw @a[distance=..48] [{"text": "<King of Zhufbar Barundin Stoneheart — Zhufbar> ", "color": "gold", "bold": true}, {"text": "Engineer-hold. Recruit if you can mind a gyrocopter; Warp-engines are grudges. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/zhufbar
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/zhufbar
