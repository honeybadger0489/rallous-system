tellraw @a[distance=..48] [{"text": "<Chieftain Gnaw — Clan Gnaw> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Gnaw does not greet. Live the knives, or die-die.", "color": "red"}]
