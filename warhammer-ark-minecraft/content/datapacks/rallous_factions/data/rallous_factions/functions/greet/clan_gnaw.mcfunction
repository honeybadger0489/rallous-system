tellraw @a[distance=..48] [{"text": "<Chieftain Gnaw — Clan Gnaw> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Gnaw. Then the Council hears.", "color": "yellow"}]
