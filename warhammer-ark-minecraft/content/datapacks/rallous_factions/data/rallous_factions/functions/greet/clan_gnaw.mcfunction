tellraw @a[distance=..48] [{"text": "<Chieftain Gnaw — Clan Gnaw> ", "color": "light_purple", "bold": true}, {"text": "Border-clan. War for the nearest burrow. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_gnaw
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_gnaw
