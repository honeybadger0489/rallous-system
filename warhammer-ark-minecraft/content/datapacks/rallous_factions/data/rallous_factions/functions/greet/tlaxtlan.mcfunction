tellraw @a[distance=..48] [{"text": "<Mage-Priest of Tlaxtlan Adohi-Tehga — Tlaxtlan> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Tlaxtlan will.", "color": "dark_purple"}]
