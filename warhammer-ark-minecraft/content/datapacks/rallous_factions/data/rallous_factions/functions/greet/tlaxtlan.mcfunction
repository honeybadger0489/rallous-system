tellraw @a[distance=..48] [{"text": "<Mage-Priest of Tlaxtlan Adohi-Tehga — Tlaxtlan> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Tlaxtlan is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
