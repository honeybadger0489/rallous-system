tellraw @a[distance=..48] [{"text": "<Wight King Krell's Banner-Bearer — The Silver Host> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of The Silver Host do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
