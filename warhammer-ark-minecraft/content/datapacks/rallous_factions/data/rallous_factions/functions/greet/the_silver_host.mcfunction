tellraw @a[distance=..48] [{"text": "<Wight King Krell's Banner-Bearer — The Silver Host> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of The Silver Host. Then we may name you guest.", "color": "yellow"}]
