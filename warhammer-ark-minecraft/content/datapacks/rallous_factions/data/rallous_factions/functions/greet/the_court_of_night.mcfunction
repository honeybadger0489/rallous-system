tellraw @a[distance=..48] [{"text": "<Prince of the Night Court Mundvard the Cruel — The Court of Night> ", "color": "dark_red", "bold": true}, {"text": "Crash-meat. Last the night among the dead of The Court of Night. Then we may name you guest.", "color": "yellow"}]
