tellraw @a[distance=..48] [{"text": "<Prince of the Night Court Mundvard the Cruel — The Court of Night> ", "color": "dark_red", "bold": true}, {"text": "Daemon-stink on living breath. The graves of The Court of Night do not trust Warp-born. Name a path, or hang with the suspected.", "color": "dark_purple"}]
