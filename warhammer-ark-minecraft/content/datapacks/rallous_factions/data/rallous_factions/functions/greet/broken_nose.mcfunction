tellraw @a[distance=..48] [{"text": "<Goblin Warboss Broken Nose — Broken Nose> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Broken Nose. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/broken_nose
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/broken_nose
