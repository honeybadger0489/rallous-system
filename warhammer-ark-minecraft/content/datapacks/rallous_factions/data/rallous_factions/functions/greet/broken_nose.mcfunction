tellraw @a[distance=..48] [{"text": "<Goblin Warboss Broken Nose — Broken Nose> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Broken Nose. Then da boss might keep ya.", "color": "yellow"}]
