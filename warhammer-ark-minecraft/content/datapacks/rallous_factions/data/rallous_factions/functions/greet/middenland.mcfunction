tellraw @a[distance=..48] [{"text": "<Elector Count of Middenland Boris Todbringer — Middenland> ", "color": "red", "bold": true}, {"text": "The Warp spat you onto Middenland soil. Take a blade. Hold the line — or walk on and be meat for the next banner.", "color": "white"}]
