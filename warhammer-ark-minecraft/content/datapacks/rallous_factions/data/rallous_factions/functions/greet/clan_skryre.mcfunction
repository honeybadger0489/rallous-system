tellraw @a[distance=..48] [{"text": "<Chief Warlock Ikit Claw — Clan Skryre> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Skryre. Then the Council hears.", "color": "yellow"}]
