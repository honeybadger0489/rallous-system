tellraw @a[distance=..48] [{"text": "<Chief Warlock Ikit Claw — Clan Skryre> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Skryre does not greet. Live the knives, or die-die.", "color": "red"}]
