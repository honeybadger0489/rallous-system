tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Bloody Spearz Boss — Bloody Spearz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Bloody Spearz. Then da boss might keep ya.", "color": "yellow"}]
