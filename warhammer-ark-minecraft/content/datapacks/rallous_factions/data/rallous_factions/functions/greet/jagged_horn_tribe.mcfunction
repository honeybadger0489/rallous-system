tellraw @a[distance=..48] [{"text": "<Wargor Jagged-Horn — Jagged-Horn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Mountain herd. Tribute in captives if you cannot win the scrap. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/jagged_horn_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/jagged_horn_tribe
