tellraw @a[distance=..48] [{"text": "<Wargor Jagged-Horn — Jagged-Horn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Jagged-Horn Tribe does not share this camp. Run, or be eaten.", "color": "red"}]
