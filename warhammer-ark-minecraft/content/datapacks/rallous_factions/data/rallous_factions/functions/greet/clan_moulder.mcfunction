tellraw @a[distance=..48] [{"text": "<Master Moulder Throt the Unclean — Clan Moulder> ", "color": "light_purple", "bold": true}, {"text": "Wants living specimens. Tribute in beasts; your tames are inventory. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_moulder
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_moulder
