tellraw @a[distance=..48] [{"text": "<Master Moulder Throt the Unclean — Clan Moulder> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Moulder. Then the Council hears.", "color": "yellow"}]
