tellraw @a[distance=..48] [{"text": "<Master Moulder Throt the Unclean — Clan Moulder> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Moulder does not greet. Live the knives, or die-die.", "color": "red"}]
