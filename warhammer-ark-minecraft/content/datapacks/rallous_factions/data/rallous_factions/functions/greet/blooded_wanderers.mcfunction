tellraw @a[distance=..48] [{"text": "<Khorne's Champion Skulltaker — Blooded Wanderers> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. The Blood Host of Blooded Wanderers does not treat Warp-spawn as guests. Survive, or die on this picket.", "color": "red"}]
