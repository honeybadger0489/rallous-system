tellraw @a[distance=..48] [{"text": "<Khorne's Champion Skulltaker — Blooded Wanderers> ", "color": "dark_red", "bold": true}, {"text": "You are the offering. Survive Blooded Wanderers, or die on this picket.", "color": "red"}]
