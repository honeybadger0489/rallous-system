tellraw @a[distance=..48] [{"text": "<Warlord Skrat — Clan Skrat> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Skrat. Then the Council hears.", "color": "yellow"}]
