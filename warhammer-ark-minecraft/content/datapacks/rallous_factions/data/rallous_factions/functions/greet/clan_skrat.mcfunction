tellraw @a[distance=..48] [{"text": "<Warlord Skrat — Clan Skrat> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Skrat does not greet. Live the knives, or die-die.", "color": "red"}]
