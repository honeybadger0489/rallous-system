tellraw @a[distance=..48] [{"text": "<Beastlord Ghorros Blood-Axe — Blooded-Axe Tribe> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Blooded-Axe Tribe does not share this camp. Run, or be eaten.", "color": "red"}]
