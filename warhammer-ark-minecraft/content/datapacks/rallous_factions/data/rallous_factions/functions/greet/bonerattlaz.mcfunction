tellraw @a[distance=..48] [{"text": "<Orc Warboss Azhag the Slaughterer — Bonerattlaz> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Bonerattlaz. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
