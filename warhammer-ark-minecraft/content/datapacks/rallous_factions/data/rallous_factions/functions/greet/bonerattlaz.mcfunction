tellraw @a[distance=..48] [{"text": "<Orc Warboss Azhag the Slaughterer — Bonerattlaz> ", "color": "green", "bold": true}, {"text": "Crown-whispers want a warpath north. Recruit if you like loot and shouting. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/bonerattlaz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/bonerattlaz
