tellraw @a[distance=..48] [{"text": "<Orc Warboss Azhag the Slaughterer — Bonerattlaz> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Bonerattlaz. Then da boss might keep ya.", "color": "yellow"}]
