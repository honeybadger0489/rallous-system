tellraw @a[distance=..48] [{"text": "<Plague Lord Lord Skrolk — Clan Pestilens> ", "color": "light_purple", "bold": true}, {"text": "Faith of disease. War on the temple-cities; strangers are plague-test subjects. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_pestilens
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_pestilens
