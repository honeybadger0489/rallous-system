tellraw @a[distance=..48] [{"text": "<Plague Lord Lord Skrolk — Clan Pestilens> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Pestilens does not greet. Live the knives, or die-die.", "color": "red"}]
