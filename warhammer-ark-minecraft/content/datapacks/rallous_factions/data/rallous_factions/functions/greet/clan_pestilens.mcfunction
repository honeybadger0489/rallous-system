tellraw @a[distance=..48] [{"text": "<Plague Lord Lord Skrolk — Clan Pestilens> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Pestilens. Then the Council hears.", "color": "yellow"}]
