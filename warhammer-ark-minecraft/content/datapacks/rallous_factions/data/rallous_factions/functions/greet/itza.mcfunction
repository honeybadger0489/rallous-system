tellraw @a[distance=..48] [{"text": "<The Great White Lizard Gor-Rok — Itza> ", "color": "aqua", "bold": true}, {"text": "Silent saurus of the First City. Help if the omen says you are a tool of the Plan. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/itza
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/itza
