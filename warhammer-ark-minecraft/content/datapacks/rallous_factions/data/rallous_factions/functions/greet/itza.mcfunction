tellraw @a[distance=..48] [{"text": "<The Great White Lizard Gor-Rok — Itza> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Itza will.", "color": "dark_purple"}]
