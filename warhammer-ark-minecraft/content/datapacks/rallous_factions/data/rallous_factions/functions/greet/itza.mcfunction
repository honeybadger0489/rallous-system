tellraw @a[distance=..48] [{"text": "<The Great White Lizard Gor-Rok — Itza> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Itza is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
