tellraw @a[distance=..48] [{"text": "<Warlord Tretch Craventail — Clan Rictus> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Rictus. Then the Council hears.", "color": "yellow"}]
