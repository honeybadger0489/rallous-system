tellraw @a[distance=..48] [{"text": "<Warlord Tretch Craventail — Clan Rictus> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Rictus does not greet. Live the knives, or die-die.", "color": "red"}]
