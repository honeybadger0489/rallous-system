tellraw @a[distance=..48] [{"text": "<Warlord Tretch Craventail — Clan Rictus> ", "color": "light_purple", "bold": true}, {"text": "Coward-genius. Tribute and ambushes; he will hire you to die first. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_rictus
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_rictus
