tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Snagla Grobspit — Arachnos> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Arachnos. Then da boss might keep ya.", "color": "yellow"}]
