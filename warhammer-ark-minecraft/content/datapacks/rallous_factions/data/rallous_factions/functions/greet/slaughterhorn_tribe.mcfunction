tellraw @a[distance=..48] [{"text": "<Doombull Taurox the Brass Bull — Slaughterhorn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Prey. The herd of Slaughterhorn Tribe does not share this camp. Run, or be eaten.", "color": "red"}]
