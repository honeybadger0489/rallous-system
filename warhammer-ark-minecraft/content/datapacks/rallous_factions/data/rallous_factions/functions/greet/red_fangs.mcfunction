tellraw @a[distance=..48] [{"text": "<Orc Warboss Gorfang Rotgut — Red Fangs> ", "color": "green", "bold": true}, {"text": "Prove yer a proper scrap. Last the night wiv Red Fangs. Then da boss might keep ya.", "color": "yellow"}]
