tellraw @a[distance=..48] [{"text": "<Orc Warboss Gorfang Rotgut — Red Fangs> ", "color": "green", "bold": true}, {"text": "Black Crag neighbours. Prove you can hold a gate. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/red_fangs
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/red_fangs
