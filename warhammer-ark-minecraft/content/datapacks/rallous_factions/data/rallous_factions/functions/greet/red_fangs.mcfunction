tellraw @a[distance=..48] [{"text": "<Orc Warboss Gorfang Rotgut — Red Fangs> ", "color": "green", "bold": true}, {"text": "You fell outta the sky onto Red Fangs. Take a choppa. Fight wiv us — da scrap starts now, or get krumped.", "color": "white"}]
