tellraw @a[distance=..48] [{"text": "<Assassin Kreepus — Clan Kreepus> ", "color": "light_purple", "bold": true}, {"text": "Man-thing reeks of Warp. Intruder-meat. Clan Kreepus does not greet. Live the knives, or die-die.", "color": "red"}]
