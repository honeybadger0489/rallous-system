tellraw @a[distance=..48] [{"text": "<Assassin Kreepus — Clan Kreepus> ", "color": "light_purple", "bold": true}, {"text": "Prove-prove you are not a spy. Last the night under Clan Kreepus. Then the Council hears.", "color": "yellow"}]
