tellraw @a[distance=..48] [{"text": "<Skink Chief Huatl Pool-Guard — Wardens of the Living Pools> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Wardens of the Living Pools will.", "color": "dark_purple"}]
