tellraw @a[distance=..48] [{"text": "<Skink Chief Huatl Pool-Guard — Wardens of the Living Pools> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Wardens of the Living Pools is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
