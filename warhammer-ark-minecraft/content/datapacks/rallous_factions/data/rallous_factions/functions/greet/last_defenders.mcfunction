tellraw @a[distance=..48] [{"text": "<Last Defender of Xhotl Kroq-Gar — Last Defenders> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. Last Defenders is wary. An omen must clear the Warp — or the temple will.", "color": "dark_purple"}]
