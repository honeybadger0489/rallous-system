tellraw @a[distance=..48] [{"text": "<Last Defender of Xhotl Kroq-Gar — Last Defenders> ", "color": "aqua", "bold": true}, {"text": "The Old Ones smell the Great Enemy on you. An omen must clear you — or Last Defenders will.", "color": "dark_purple"}]
