tellraw @a[distance=..48] [{"text": "<Engineer Guildmaster Malakai Makaisson — Masters of Innovation> ", "color": "gold", "bold": true}, {"text": "You stink of the Warp. Kill until Masters of Innovation names you clean, or be entered in the Book.", "color": "dark_purple"}]
