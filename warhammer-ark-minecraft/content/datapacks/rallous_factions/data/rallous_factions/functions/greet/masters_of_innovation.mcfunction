tellraw @a[distance=..48] [{"text": "<Engineer Guildmaster Malakai Makaisson — Masters of Innovation> ", "color": "gold", "bold": true}, {"text": "No oath is sworn. Masters of Innovation is wary. You stink of the Warp. Kill until the Book names you clean — or entered.", "color": "dark_purple"}]
