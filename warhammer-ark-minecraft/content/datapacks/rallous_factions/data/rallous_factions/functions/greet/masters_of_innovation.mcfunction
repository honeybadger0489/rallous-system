tellraw @a[distance=..48] [{"text": "<Engineer Guildmaster Malakai Makaisson — Masters of Innovation> ", "color": "gold", "bold": true}, {"text": "Airship science. Recruit if you can keep a boiler alive; he still watches for Warp-stink. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
