...
execute if biome ~ ~ ~ minecraft:warm_ocean run scoreboard players set $biome_ok rallous.gen 1
execute if biome ~ ~ ~ minecraft:lukewarm_ocean run scoreboard players set $biome_ok rallous.gen 1
...
execute if score $skip rallous.gen matches 0 unless score #hexoatl rallous.used matches 1 run function rallous_factions:place/hexoatl
