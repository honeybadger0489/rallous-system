...
execute if score $skip rallous.gen matches 0 unless score #ghosts_of_pahuax rallous.used matches 1 run function rallous_factions:place/ghosts_of_pahuax
