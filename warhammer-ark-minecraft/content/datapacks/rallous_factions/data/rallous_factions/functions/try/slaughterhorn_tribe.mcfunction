...
execute if score $skip rallous.gen matches 0 unless score #slaughterhorn_tribe rallous.used matches 1 run function rallous_factions:place/slaughterhorn_tribe
