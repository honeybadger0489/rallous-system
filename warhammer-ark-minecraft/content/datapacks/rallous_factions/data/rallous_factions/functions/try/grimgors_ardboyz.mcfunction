...
execute if score $skip rallous.gen matches 0 unless score #grimgors_ardboyz rallous.used matches 1 run function rallous_factions:place/grimgors_ardboyz
