...
execute if score $skip rallous.gen matches 0 unless score #cluster_eye_tribe rallous.used matches 1 run function rallous_factions:place/cluster_eye_tribe
