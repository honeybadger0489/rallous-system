# try caravan-of-blue-roses (major)
...
execute if score $skip rallous.gen matches 0 unless score #caravan_of_blue_roses rallous.used matches 1 run function rallous_factions:place/caravan_of_blue_roses
