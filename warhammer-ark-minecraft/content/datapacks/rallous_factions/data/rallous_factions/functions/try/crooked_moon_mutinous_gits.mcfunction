# try crooked-moon-mutinous-gits (minor)
...
execute if score $skip rallous.gen matches 0 unless score #crooked_moon_mutinous_gits rallous.used matches 1 run function rallous_factions:place/crooked_moon_mutinous_gits
