...
execute if score $skip rallous.gen matches 0 unless score #the_golden_order rallous.used matches 1 run function rallous_factions:place/the_golden_order
