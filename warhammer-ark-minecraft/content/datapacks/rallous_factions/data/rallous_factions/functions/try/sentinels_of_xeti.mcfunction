...
execute if score $skip rallous.gen matches 0 unless score #sentinels_of_xeti rallous.used matches 1 run function rallous_factions:place/sentinels_of_xeti
