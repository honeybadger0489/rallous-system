# try warherd-of-the-shadowgave (major)
...
execute if score $skip rallous.gen matches 0 unless score #warherd_of_the_shadowgave rallous.used matches 1 run function rallous_factions:place/warherd_of_the_shadowgave
