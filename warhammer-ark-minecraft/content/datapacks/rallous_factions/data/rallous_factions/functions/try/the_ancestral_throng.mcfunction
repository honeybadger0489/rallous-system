# try the-ancestral-throng (major)
...
execute if score $skip rallous.gen matches 0 unless score #the_ancestral_throng rallous.used matches 1 run function rallous_factions:place/the_ancestral_throng
