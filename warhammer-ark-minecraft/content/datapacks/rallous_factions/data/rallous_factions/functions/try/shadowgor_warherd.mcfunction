...
execute if score $skip rallous.gen matches 0 unless score #shadowgor_warherd rallous.used matches 1 run function rallous_factions:place/shadowgor_warherd
