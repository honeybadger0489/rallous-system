...
execute if score $skip rallous.gen matches 0 unless score #southern_sentinels rallous.used matches 1 run function rallous_factions:place/southern_sentinels
