...
execute if score $skip rallous.gen matches 0 unless score #leaf_cutterz_tribe rallous.used matches 1 run function rallous_factions:place/leaf_cutterz_tribe
