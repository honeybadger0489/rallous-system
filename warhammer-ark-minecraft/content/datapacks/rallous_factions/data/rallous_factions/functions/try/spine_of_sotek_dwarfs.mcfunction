# try spine-of-sotek-dwarfs (minor)
...
execute if score $skip rallous.gen matches 0 unless score #spine_of_sotek_dwarfs rallous.used matches 1 run function rallous_factions:place/spine_of_sotek_dwarfs
