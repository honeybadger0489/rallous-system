# try challengers-of-khorne (major)
...
execute if score $skip rallous.gen matches 0 unless score #challengers_of_khorne rallous.used matches 1 run function rallous_factions:place/challengers_of_khorne
