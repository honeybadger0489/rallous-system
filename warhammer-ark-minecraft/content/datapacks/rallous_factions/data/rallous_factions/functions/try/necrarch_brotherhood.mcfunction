# try necrarch-brotherhood (minor)
...
execute if score $skip rallous.gen matches 0 unless score #necrarch_brotherhood rallous.used matches 1 run function rallous_factions:place/necrarch_brotherhood
