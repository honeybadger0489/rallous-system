# try masters-of-innovation (major)
...
execute if score $skip rallous.gen matches 0 unless score #masters_of_innovation rallous.used matches 1 run function rallous_factions:place/masters_of_innovation
