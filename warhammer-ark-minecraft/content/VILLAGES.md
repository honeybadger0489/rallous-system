...
**Ship `rallous_grow`.** The 7×7 crash camp grows when you help, win `rallous.session`, or spend emeralds. One well-known colony sim (MineColonies) **does** have 1.20.1 Forge fileIDs, but it is a five-jar overlay that fights Recruits as a second capital. Catalog entries are pinned for a later opt-in. They are **not** in the 0.3.7 default zip.
...
| **Villager Recruits** | Yes. Modrinth `2zXpVxK4` = `recruits-1.20.1-1.15.2.jar` (2026-06-29). CF **523860 / fileID 8339846**. | **Already in 0.3.7.** Claims, banners, hire, siege. | Army + province claim. Not village *growth*. |
| **Guard Villagers** | Yes. Modrinth `zCzBkn3R` = `guardvillagers-1.20.1-1.6.19.jar` (2026-08-23). CF **360203 / fileID 8719057**. | **Already in 0.3.7.** | Occupied Towns-and-Towers villages fight. No build-as-you-help. |
