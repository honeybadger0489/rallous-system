...
This pack does **not** ship MineColonies in the 0.3.8 zip. Recruits already owns banners and claims. Guard Villagers and Towns and Towers already make *other people’s* towns look alive. The cheap loop that ships is **`rallous_grow`** on the 7×7 crash camp.
