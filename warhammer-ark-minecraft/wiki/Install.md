...
Import the **latest** zip as a **new** CurseForge profile. Do not update 0.2.x / 0.3.0–0.3.4. **0.3.5** is the last “session + bind” ship; this branch currently names **0.3.6**.
...
Older `dist/rallous-warhammer-fantasy-0.3.5.zip` still exists if you need that pin.
