...
Import the **latest** zip as a **new** CurseForge profile. Do not update 0.2.x / 0.3.0–0.3.6. **0.3.7** is this ship.
...
Older `dist/rallous-warhammer-fantasy-0.3.6.zip` still exists if you need that pin.
