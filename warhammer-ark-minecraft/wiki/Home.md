...
- Client is not booted in CI. Crash on boot → send `crash-*-fml.txt`. Dedicated-server smoke **passed on 0.3.10**. **0.3.11** is unsmoked.

## Play

1. [Install](Install.md) **0.3.11** as a **new** CurseForge profile. Do not update 0.2.x / 0.3.0–0.3.10.
