...
This folder is the friend-facing pack wiki. Not research, not a zip rebuild, not a tour of coordinates.

| Page | What |
| --- | --- |
| [Home](Home.md) | What this pack *is* |
| [Install](Install.md) | Zip, CurseForge, Java 17, Continuity |
...
Sidebar for wiki.js / Docsify: [_sidebar.md](_sidebar.md).
