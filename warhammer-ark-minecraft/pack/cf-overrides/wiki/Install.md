...
Dedicated-server smoke **passed on 0.3.12, 0.3.13, and 0.3.14** (`Done`, no `ModLoadingException`, no function parse errors). **0.3.14** is the first-hour gameplay pass (greet at the picket, closer camp, roaming first-host guarantee, claimed-camp beds, Recruits retry). Client TEST is still unverified.
