...
- [ ] The lord speaks a **stance that depends on that race**: Empire blade-and-fight, Greenskins scrap, Dwarfs/Lizardmen wary, Vampire Counts / Skaven / Beastmen / Khorne hostile or daemon-suspicion. Not one shared sentence for every host. Hostile hosts **fight** (raid on approach). Wary hosts give no free kit until a path.
