...
- Camps are palisade + banners + a lord + two soldiers. Not Altdorf.
...
- Client is not booted in CI. Crash on boot → send `crash-*-fml.txt`. Dedicated-server smoke **passed on 0.3.11**. **0.3.12** is this ship (copy / leftover-court cut; dedicated smoke of 0.3.12 not rerun).

## Play

1. [Install](Install.md) **0.3.12** as a **new** CurseForge profile. Do not update 0.2.x / 0.3.0–0.3.11.
