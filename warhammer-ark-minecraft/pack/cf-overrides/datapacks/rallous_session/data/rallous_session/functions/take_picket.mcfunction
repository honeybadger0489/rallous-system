...
execute if entity @s[tag=rallous.session.live] unless score @s rallous.session_kind matches 3 run tellraw @s {"text":"This night is a defence, not a sack. Clear the wave or /function rallous_session:win","color":"gray"}
