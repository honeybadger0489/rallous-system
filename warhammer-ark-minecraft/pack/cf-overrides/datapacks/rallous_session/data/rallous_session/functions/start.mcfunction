...
execute unless entity @e[tag=rallous.session.camp,limit=1] run tellraw @s {"text":"No contact camp. Crash first, walk to a banner, then /function rallous_session:start","color":"gray"}
