...
execute as @a if score @s rallous.greeted matches 1.. unless score @s rallous.kitted matches 1.. if score @s rallous.race matches 1..8 run function rallous_kit:on_greet
