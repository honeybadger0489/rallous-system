tellraw @a[distance=..48] [{"text": "<King of Karak Norn Brokk Ironpick — Karak Norn> ", "color": "gold", "bold": true}, {"text": "Grey Mountains. Daemon-suspicion of anything from Athel Loren or the Warp. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/karak_norn
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/karak_norn
