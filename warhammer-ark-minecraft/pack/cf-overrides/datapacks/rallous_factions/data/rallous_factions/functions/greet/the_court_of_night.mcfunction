tellraw @a[distance=..48] [{"text": "<Prince of the Night Court Mundvard the Cruel — The Court of Night> ", "color": "dark_red", "bold": true}, {"text": "City-haunt. Prove you can move unseen; he offers contracts, not friendship. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/the_court_of_night
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/the_court_of_night
