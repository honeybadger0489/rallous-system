tellraw @a[distance=..48] [{"text": "<Mage-Priest of the Mists Uaxti — Xlanhuapec> ", "color": "aqua", "bold": true}, {"text": "City of Mist. Outsiders who glimpse the plaza are a war-casus. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
