tellraw @a[distance=..48] [{"text": "<Orc Warboss Still-Chained Urk — Slaves of Zharr> ", "color": "green", "bold": true}, {"text": "Still under Hashut's lash. Help break them or they fight you on orders. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/slaves_of_zharr
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/slaves_of_zharr
