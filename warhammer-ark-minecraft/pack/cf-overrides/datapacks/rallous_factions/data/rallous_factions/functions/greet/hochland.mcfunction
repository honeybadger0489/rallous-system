tellraw @a[distance=..48] [{"text": "<Elector Count of Hochland Aldebrand Ludenhof — Hochland> ", "color": "red", "bold": true}, {"text": "Quiet forest count. Hires marksmen; distrusts loud magic and Warp-stink. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
