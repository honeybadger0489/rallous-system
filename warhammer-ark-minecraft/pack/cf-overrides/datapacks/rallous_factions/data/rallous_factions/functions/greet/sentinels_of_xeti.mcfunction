tellraw @a[distance=..48] [{"text": "<Skink Oracle Xeti-Watcher — Sentinels of Xeti> ", "color": "aqua", "bold": true}, {"text": "Star-chamber guards. Prove you read no false omen. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
