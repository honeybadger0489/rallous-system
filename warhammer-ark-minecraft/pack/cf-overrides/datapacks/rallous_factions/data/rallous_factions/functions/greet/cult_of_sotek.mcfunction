tellraw @a[distance=..48] [{"text": "<Prophet of Sotek Tehenhauin — Cult of Sotek> ", "color": "aqua", "bold": true}, {"text": "Rat-hate crusade. War on Skaven; a stranger may join the sacrifice-road or leave. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/cult_of_sotek
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/cult_of_sotek
