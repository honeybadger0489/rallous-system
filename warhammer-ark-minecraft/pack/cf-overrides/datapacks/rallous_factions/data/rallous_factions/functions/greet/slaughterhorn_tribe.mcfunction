tellraw @a[distance=..48] [{"text": "<Doombull Taurox the Brass Bull — Slaughterhorn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Minotaur rampage. Recruit only if you already wear brass and blood. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/slaughterhorn_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/slaughterhorn_tribe
