tellraw @a[distance=..48] [{"text": "<Great Bray-Shaman Malagor the Dark Omen — Harbinger of Disaster> ", "color": "dark_green", "bold": true}, {"text": "Wants the world unmade. Prove nothing; flee or fight. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/harbinger_of_disaster
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/harbinger_of_disaster
