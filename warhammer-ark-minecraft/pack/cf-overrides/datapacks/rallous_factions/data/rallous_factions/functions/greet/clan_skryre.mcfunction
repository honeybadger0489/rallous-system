tellraw @a[distance=..48] [{"text": "<Chief Warlock Ikit Claw — Clan Skryre> ", "color": "light_purple", "bold": true}, {"text": "Wants Warp-tech and testers. Recruit if you survive the first experiment. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_skryre
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_skryre
