tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Gitilla's Cousin — Crooked Moon Mutinous Gits> ", "color": "green", "bold": true}, {"text": "Skarsnik's leftovers. Recruit if you pay in mushrooms. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
