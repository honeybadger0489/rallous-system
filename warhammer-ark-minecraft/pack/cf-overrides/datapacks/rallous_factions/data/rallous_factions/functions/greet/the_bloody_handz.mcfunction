tellraw @a[distance=..48] [{"text": "<Great Shaman Wurrzag da Great Green Prophet — The Bloody Handz> ", "color": "green", "bold": true}, {"text": "Wants a proper Waaagh. Prove you are lucky, not clever. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/the_bloody_handz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/the_bloody_handz
