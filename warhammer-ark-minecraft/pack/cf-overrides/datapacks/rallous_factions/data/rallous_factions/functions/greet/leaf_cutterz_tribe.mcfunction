tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Leaf-Cutter — Leaf-Cutterz Tribe> ", "color": "green", "bold": true}, {"text": "Lustrian wilds. Recruit if you bring a big choppa. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/leaf_cutterz_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/leaf_cutterz_tribe
