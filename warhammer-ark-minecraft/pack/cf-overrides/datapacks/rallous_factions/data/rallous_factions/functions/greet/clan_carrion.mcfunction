tellraw @a[distance=..48] [{"text": "<Warlord Carrion-Take — Clan Carrion> ", "color": "light_purple", "bold": true}, {"text": "Scavenger clan. Tribute in scrap. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_carrion
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_carrion
