tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Skarsnik — Crooked Moon> ", "color": "green", "bold": true}, {"text": "Eight Peaks politics. Tribute in shinies; war if you back Belegar. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
