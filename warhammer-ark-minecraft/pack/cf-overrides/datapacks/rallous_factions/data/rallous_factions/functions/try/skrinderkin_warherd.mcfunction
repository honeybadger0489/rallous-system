...
execute if score $skip rallous.gen matches 0 unless score #skrinderkin_warherd rallous.used matches 1 run function rallous_factions:place/skrinderkin_warherd
