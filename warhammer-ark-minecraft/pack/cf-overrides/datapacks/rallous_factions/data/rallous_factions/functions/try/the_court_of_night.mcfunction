...
execute if score $skip rallous.gen matches 0 unless score #the_court_of_night rallous.used matches 1 run function rallous_factions:place/the_court_of_night
