# try the-drakenhof-conclave (major)
...
execute if score $skip rallous.gen matches 0 unless score #the_drakenhof_conclave rallous.used matches 1 run function rallous_factions:place/the_drakenhof_conclave
