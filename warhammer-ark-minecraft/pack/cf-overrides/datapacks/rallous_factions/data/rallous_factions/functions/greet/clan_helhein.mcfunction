tellraw @a[distance=..48] [{"text": "<Thane Helhein — Clan Helhein> ", "color": "gold", "bold": true}, {"text": "Exiles in the east. Prove you are not another broken oath. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_helhein
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_helhein
