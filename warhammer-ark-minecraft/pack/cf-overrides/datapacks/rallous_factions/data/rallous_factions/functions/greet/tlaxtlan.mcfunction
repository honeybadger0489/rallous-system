tellraw @a[distance=..48] [{"text": "<Mage-Priest of Tlaxtlan Adohi-Tehga — Tlaxtlan> ", "color": "aqua", "bold": true}, {"text": "City of the Moon. Recruit skink envoys if you bring star-metal, not Warp-toys. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/tlaxtlan
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/tlaxtlan
