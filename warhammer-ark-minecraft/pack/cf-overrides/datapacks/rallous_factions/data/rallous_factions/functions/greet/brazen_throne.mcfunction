tellraw @a[distance=..48] [{"text": "<Bloodmaster Brazen Throne — Brazen Throne> ", "color": "dark_red", "bold": true}, {"text": "Claims a moving dais of brass. Tribute in skulls if you will not fight. This host does not treat crash-meat as a guest.", "color": "red"}]
