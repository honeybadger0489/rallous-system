tellraw @a[distance=..48] [{"text": "<Packmaster Verms — Clan Verms> ", "color": "light_purple", "bold": true}, {"text": "Insect-and-rat clan. Tribute in chitin. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
