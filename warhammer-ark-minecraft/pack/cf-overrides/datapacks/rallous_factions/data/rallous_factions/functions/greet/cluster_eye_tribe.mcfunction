tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Cluster-Eye — Cluster-Eye Tribe> ", "color": "green", "bold": true}, {"text": "Cave goblins. War in the dark. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
