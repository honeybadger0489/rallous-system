tellraw @a[distance=..48] [{"text": "<Chieftain Mange — Clan Mange> ", "color": "light_purple", "bold": true}, {"text": "Mangy under-clan. War for food-food. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_mange
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_mange
