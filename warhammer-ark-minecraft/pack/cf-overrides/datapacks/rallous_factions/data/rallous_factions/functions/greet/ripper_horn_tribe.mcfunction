tellraw @a[distance=..48] [{"text": "<Beastlord Ripper-Horn — Ripper-Horn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Southlands herd. Recruit if you already run with horns. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/ripper_horn_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/ripper_horn_tribe
