tellraw @a[distance=..48] [{"text": "<Orc Warboss Skull Crag — Skull Crag> ", "color": "green", "bold": true}, {"text": "Mountain scrap-hold. War. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
