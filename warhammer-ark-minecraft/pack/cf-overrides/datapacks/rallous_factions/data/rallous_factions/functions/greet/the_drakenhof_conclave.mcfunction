tellraw @a[distance=..48] [{"text": "<Count of Sylvania Mannfred von Carstein — The Drakenhof Conclave> ", "color": "dark_red", "bold": true}, {"text": "Schemer. Offers alliance-as-use: fight his rivals, pay in blood, expect betrayal. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/the_drakenhof_conclave
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/the_drakenhof_conclave
