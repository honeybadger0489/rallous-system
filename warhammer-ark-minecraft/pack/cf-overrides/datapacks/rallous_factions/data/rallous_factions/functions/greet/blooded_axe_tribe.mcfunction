tellraw @a[distance=..48] [{"text": "<Beastlord Ghorros Blood-Axe — Blooded-Axe Tribe> ", "color": "dark_green", "bold": true}, {"text": "Axe-herd of the deep wood. War is the greeting. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/blooded_axe_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/blooded_axe_tribe
