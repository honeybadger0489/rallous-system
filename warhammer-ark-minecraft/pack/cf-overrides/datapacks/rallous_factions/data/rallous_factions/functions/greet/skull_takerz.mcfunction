tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Skull-taka — Skull-takerz> ", "color": "green", "bold": true}, {"text": "Collects heads. Tribute in skulls or fight. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/skull_takerz
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/skull_takerz
