...
execute if score $skip rallous.gen matches 0 unless score #exiles_of_khorne rallous.used matches 1 run function rallous_factions:place/exiles_of_khorne
