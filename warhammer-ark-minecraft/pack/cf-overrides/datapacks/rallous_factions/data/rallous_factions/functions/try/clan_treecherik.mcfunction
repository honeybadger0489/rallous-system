...
execute if score $skip rallous.gen matches 0 unless score #clan_treecherik rallous.used matches 1 run function rallous_factions:place/clan_treecherik
