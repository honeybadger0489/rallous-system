tellraw @a[distance=..48] [{"text": "<Goblin Warboss Scabby Eye — Scabby Eye> ", "color": "green", "bold": true}, {"text": "Badlands gits. Tribute or a kicking. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
