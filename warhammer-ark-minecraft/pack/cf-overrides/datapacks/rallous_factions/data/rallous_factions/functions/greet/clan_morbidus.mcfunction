tellraw @a[distance=..48] [{"text": "<Plague Priest Morbidus — Clan Morbidus> ", "color": "light_purple", "bold": true}, {"text": "Pestilens splinter. War and pox. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_morbidus
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_morbidus
