tellraw @a[distance=..48] [{"text": "<Last Defender of Xhotl Kroq-Gar — Last Defenders> ", "color": "aqua", "bold": true}, {"text": "Purges warmbloods from the Southlands. Recruit only if you hunt the same blight. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/last_defenders
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/last_defenders
