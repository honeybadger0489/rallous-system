tellraw @a[distance=..48] [{"text": "<Saurus Oldblood Lotl of the South — Southern Sentinels> ", "color": "aqua", "bold": true}, {"text": "Watch-posts on the Cape. Help hold the coast against warmblood landings. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/southern_sentinels
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/southern_sentinels
