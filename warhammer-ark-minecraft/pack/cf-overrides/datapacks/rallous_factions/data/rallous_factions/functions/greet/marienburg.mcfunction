tellraw @a[distance=..48] [{"text": "<Director of Marienburg Leopold van Haagen — Marienburg> ", "color": "red", "bold": true}, {"text": "Everything is a contract. Tribute and river-tolls before friendship. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/marienburg
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/marienburg
