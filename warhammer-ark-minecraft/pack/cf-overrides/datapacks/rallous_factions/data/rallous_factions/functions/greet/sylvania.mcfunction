tellraw @a[distance=..48] [{"text": "<Vampire Count of Sylvania Vlad von Carstein — Sylvania> ", "color": "dark_red", "bold": true}, {"text": "Courteous tyrant. Prove you can keep a living town quiet, or join the grave-levy. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/sylvania
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/sylvania
