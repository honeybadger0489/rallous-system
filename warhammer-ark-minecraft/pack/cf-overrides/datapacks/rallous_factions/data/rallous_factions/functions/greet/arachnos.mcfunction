tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Snagla Grobspit — Arachnos> ", "color": "green", "bold": true}, {"text": "Forest spiders. War from the canopy. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
