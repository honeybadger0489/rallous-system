tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Bloody Spearz Boss — Bloody Spearz> ", "color": "green", "bold": true}, {"text": "Worlds Edge lurkers. War under the peaks. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
