tellraw @a[distance=..48] [{"text": "<Exalted Hero of Khorne Son of Kharneth — Kharneth's Sons> ", "color": "dark_red", "bold": true}, {"text": "Realm of Chaos remnant host. War. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/kharneths_sons
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/kharneths_sons
