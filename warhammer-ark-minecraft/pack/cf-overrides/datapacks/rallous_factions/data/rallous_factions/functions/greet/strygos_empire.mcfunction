tellraw @a[distance=..48] [{"text": "<Ghoul King Gashnag — Strygos Empire> ", "color": "dark_red", "bold": true}, {"text": "Southlands remnant. Tribute in meat and captives; no open roads. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
