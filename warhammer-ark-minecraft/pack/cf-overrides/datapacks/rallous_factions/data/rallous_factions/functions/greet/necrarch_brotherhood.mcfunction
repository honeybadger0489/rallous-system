tellraw @a[distance=..48] [{"text": "<Necrarch Master Melkhior the Ancient — Necrarch Brotherhood> ", "color": "dark_red", "bold": true}, {"text": "Tower-scholar of undeath. Prove you can fetch reagents; he will not ride to save you. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/necrarch_brotherhood
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/necrarch_brotherhood
