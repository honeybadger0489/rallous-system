tellraw @a[distance=..48] [{"text": "<Forest Goblin Warboss Creeping Death — Creeping Death> ", "color": "green", "bold": true}, {"text": "Lustrian spider-goblins. No open roads. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
