tellraw @a[distance=..48] [{"text": "<Warlord Gritus — Clan Gritus> ", "color": "light_purple", "bold": true}, {"text": "Southlands under-city. Recruit stormvermin if you pay warp-tokens. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_gritus
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_gritus
