tellraw @a[distance=..48] [{"text": "<King of Barak Varr Byrrnoth Grundadrakk — Barak Varr> ", "color": "gold", "bold": true}, {"text": "Sea Hold. Open roads (sea-lanes) for those who pay the dock-tithe. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
