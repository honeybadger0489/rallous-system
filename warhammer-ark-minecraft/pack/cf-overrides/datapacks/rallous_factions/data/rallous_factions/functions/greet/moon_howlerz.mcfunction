tellraw @a[distance=..48] [{"text": "<Night Goblin Warboss Moon Howler — Moon Howlerz> ", "color": "green", "bold": true}, {"text": "Howling caves. Tribute in shiny rocks. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
