tellraw @a[distance=..48] [{"text": "<Plague Priest Septik — Clan Septik> ", "color": "light_purple", "bold": true}, {"text": "Festering clan. Tribute in spoiled grain. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_septik
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_septik
