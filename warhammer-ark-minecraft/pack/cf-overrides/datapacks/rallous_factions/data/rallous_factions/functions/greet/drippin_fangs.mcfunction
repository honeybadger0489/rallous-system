tellraw @a[distance=..48] [{"text": "<Savage Orc Warboss Drippin Fangs — Drippin Fangs> ", "color": "green", "bold": true}, {"text": "Southlands biters. Prove you bite harder. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
