tellraw @a[distance=..48] [{"text": "<Thane Greybeard — Greybeard's Prospectors> ", "color": "gold", "bold": true}, {"text": "Lustrian miners. Recruit guards for the claim. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
