tellraw @a[distance=..48] [{"text": "<Goblin Warboss Broken Nose — Broken Nose> ", "color": "green", "bold": true}, {"text": "Badlands sneaks. Tribute in teef. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
