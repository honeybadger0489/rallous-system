tellraw @a[distance=..48] [{"text": "<High King of the Karaz Ankor Thorgrim Grudgebearer — Karaz-a-Karak> ", "color": "gold", "bold": true}, {"text": "Every Warp-stranger is a possible grudge. Swear an oath, settle a line, then he helps. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/karaz_a_karak
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/karaz_a_karak
