tellraw @a[distance=..48] [{"text": "<Gorebull Redhorn — Redhorn Tribe> ", "color": "dark_green", "bold": true}, {"text": "Bloodied minotaurs. War or a skull-tithe. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/redhorn_tribe
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/redhorn_tribe
