tellraw @a[distance=..48] [{"text": "<Supreme Patriarch Balthasar Gelt — The Golden Order> ", "color": "red", "bold": true}, {"text": "Gold-masked academic. Prove you are not a daemon; then he will sell you a formula. Warp-born, take a blade. Hold the line and we will name you useful.", "color": "white"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/the_golden_order
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/the_golden_order
