tellraw @a[distance=..48] [{"text": "<Assassin Kreepus — Clan Kreepus> ", "color": "light_purple", "bold": true}, {"text": "Eshin-adjacent sneaks. Prove you can vanish. Prove yourself. Until then you are a Warp-stranger, not a guest.", "color": "yellow"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/clan_kreepus
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/clan_kreepus
