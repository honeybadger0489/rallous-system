tellraw @a[distance=..48] [{"text": "<Master of Skies Tiktaq'to — Tlaqua> ", "color": "aqua", "bold": true}, {"text": "Aerial temple-city. Prove you can scout; he will not open the star-chamber. You stink of the Warp. Daemon? Prove you are not, or be slain.", "color": "dark_purple"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/tlaqua
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/tlaqua
