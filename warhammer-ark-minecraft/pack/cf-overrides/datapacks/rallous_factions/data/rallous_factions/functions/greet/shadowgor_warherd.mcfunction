tellraw @a[distance=..48] [{"text": "<Beastlord Shadowgor — Shadowgor Warherd> ", "color": "dark_green", "bold": true}, {"text": "Night-herd. No roads, no heralds. This host does not treat crash-meat as a guest.", "color": "red"}]
...
execute if score @s rallous.fac.stance matches 3 run function rallous_factions:raid/shadowgor_warherd
execute if score @s rallous.fac.stance matches 6 run function rallous_factions:raid/shadowgor_warherd
