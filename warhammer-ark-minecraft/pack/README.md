...
**Players: read [PLAY.md](../PLAY.md) only.** Import `../dist/rallous-warhammer-fantasy-0.3.5.zip` in the CurseForge app.
...
```bash
python3 ../scripts/integrate-overrides.py --version 0.3.5
```
