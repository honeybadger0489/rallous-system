...
def main() -> None:
    ...
    parser.add_argument("--version", default="0.2.2", help="Pack version stamped into the zip manifest")
    ...
    if MODLIST.exists():
        ...
        text = text.replace("0.2.1", args.version).replace("0.2.0", args.version)
