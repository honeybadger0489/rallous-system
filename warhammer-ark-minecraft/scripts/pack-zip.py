...
def main() -> None:
    ...
    parser.add_argument("--version", default="0.3.7", help="Pack version stamped into the zip manifest")
    ...
    if MODLIST.exists():
        ...
        for old in ("0.2.0", "0.2.1", "0.2.2", "0.3.0", "0.3.1", "0.3.2", "0.3.3", "0.3.4", "0.3.5", "0.3.6"):
